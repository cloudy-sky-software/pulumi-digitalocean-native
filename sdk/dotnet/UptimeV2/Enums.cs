...
namespace Pulumi.DigitalOceanNative.UptimeV2
{
    ...
    [EnumType]
    public readonly struct UptimeCheckCheckUpdatableRegionsItem : IEquatable<UptimeCheckCheckUpdatableRegionsItem>
    {
        private readonly string _value;

        private UptimeCheckCheckUpdatableRegionsItem(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static UptimeCheckCheckUpdatableRegionsItem UsEast { get; } = new UptimeCheckCheckUpdatableRegionsItem("us_east");
        public static UptimeCheckCheckUpdatableRegionsItem UsWest { get; } = new UptimeCheckCheckUpdatableRegionsItem("us_west");
        public static UptimeCheckCheckUpdatableRegionsItem EuWest { get; } = new UptimeCheckCheckUpdatableRegionsItem("eu_west");
        public static UptimeCheckCheckUpdatableRegionsItem SeAsia { get; } = new UptimeCheckCheckUpdatableRegionsItem("se_asia");

        public static bool operator ==(UptimeCheckCheckUpdatableRegionsItem left, UptimeCheckCheckUpdatableRegionsItem right) => left.Equals(right);
        public static bool operator !=(UptimeCheckCheckUpdatableRegionsItem left, UptimeCheckCheckUpdatableRegionsItem right) => !left.Equals(right);

        public static explicit operator string(UptimeCheckCheckUpdatableRegionsItem value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is UptimeCheckCheckUpdatableRegionsItem other && Equals(other);
        public bool Equals(UptimeCheckCheckUpdatableRegionsItem other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct UptimeCheckCheckUpdatableType : IEquatable<UptimeCheckCheckUpdatableType>
    {
        private readonly string _value;

        private UptimeCheckCheckUpdatableType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static UptimeCheckCheckUpdatableType Ping { get; } = new UptimeCheckCheckUpdatableType("ping");
        public static UptimeCheckCheckUpdatableType Http { get; } = new UptimeCheckCheckUpdatableType("http");
        public static UptimeCheckCheckUpdatableType Https { get; } = new UptimeCheckCheckUpdatableType("https");

        public static bool operator ==(UptimeCheckCheckUpdatableType left, UptimeCheckCheckUpdatableType right) => left.Equals(right);
        public static bool operator !=(UptimeCheckCheckUpdatableType left, UptimeCheckCheckUpdatableType right) => !left.Equals(right);

        public static explicit operator string(UptimeCheckCheckUpdatableType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is UptimeCheckCheckUpdatableType other && Equals(other);
        public bool Equals(UptimeCheckCheckUpdatableType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
