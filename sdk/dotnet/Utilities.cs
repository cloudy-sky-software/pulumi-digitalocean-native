...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/cloudy-sky-software/pulumi-digitalocean-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("CloudySkySoftware.Pulumi.DigitalOceanNative.version.txt");
    ...
    internal sealed class DigitalOceanNativeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DigitalOceanNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
