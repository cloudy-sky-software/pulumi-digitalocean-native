...
{
    [DigitalOceanNativeResourceType("digitalocean-native:apps/v2:App")]
    public partial class App : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("app")]
        public Output<Outputs.App?> AppValue { get; private set; } = null!;
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:apps/v2:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:apps/v2:App", name, null, MakeResourceOptions(options, id))
        {
        }
