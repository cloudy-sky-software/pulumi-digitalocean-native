...
namespace Pulumi.DigitalOceanNative.DropletsV2
{
    ...
    {
        public readonly Outputs.ListDropletsAssociatedResources Items;

        [OutputConstructor]
        private ListDropletsAssociatedResourcesResult(Outputs.ListDropletsAssociatedResources items)
        {
            Items = items;
        }
    }
