...
namespace Pulumi.DigitalOceanNative.DropletsV2
{
    ...
    public partial class Rebuild : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("type")]
        public Output<Pulumi.DigitalOceanNative.DropletsV2.RebuildDropletActionType?> Type { get; private set; } = null!;
    ...
    public sealed class RebuildArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.DigitalOceanNative.DropletsV2.RebuildDropletActionType> Type { get; set; } = null!;
