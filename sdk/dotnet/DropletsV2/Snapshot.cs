...
{
    [DigitalOceanNativeResourceType("digitalocean-native:droplets/v2:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("type")]
        public Output<Pulumi.DigitalOceanNative.DropletsV2.SnapshotDropletActionType?> Type { get; private set; } = null!;
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:droplets/v2:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:droplets/v2:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.DigitalOceanNative.DropletsV2.SnapshotDropletActionType> Type { get; set; } = null!;
