...
{
    [DigitalOceanNativeResourceType("digitalocean-native:account/v2:SshKey")]
    public partial class SshKey : global::Pulumi.CustomResource
    {
        ...
        [Output("sshKey")]
        public Output<Outputs.SshKeys?> SshKeyValue { get; private set; } = null!;
        ...
        public SshKey(string name, SshKeyArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:account/v2:SshKey", name, args ?? new SshKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:account/v2:SshKey", name, null, MakeResourceOptions(options, id))
        {
        }
