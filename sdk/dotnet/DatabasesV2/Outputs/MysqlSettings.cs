...
namespace Pulumi.DigitalOceanNative.DatabasesV2.Outputs
{
    ...
    public sealed class MysqlSettings
    {
        ...
        /// </summary>
        public readonly Pulumi.DigitalOceanNative.DatabasesV2.MysqlSettingsAuthPlugin AuthPlugin;

        [OutputConstructor]
        private MysqlSettings(Pulumi.DigitalOceanNative.DatabasesV2.MysqlSettingsAuthPlugin authPlugin)
        {
