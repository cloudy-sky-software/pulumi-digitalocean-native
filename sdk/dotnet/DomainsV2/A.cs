...
{
    [DigitalOceanNativeResourceType("digitalocean-native:domains/v2:A")]
    public partial class A : global::Pulumi.CustomResource
    {
        ...
        public A(string name, AArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:domains/v2:A", name, args ?? new AArgs(), MakeResourceOptions(options, ""))
        {
        }

        private A(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:domains/v2:A", name, null, MakeResourceOptions(options, id))
        {
        }
