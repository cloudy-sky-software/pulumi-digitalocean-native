...
{
    [DigitalOceanNativeResourceType("digitalocean-native:domains/v2:Ns")]
    public partial class Ns : global::Pulumi.CustomResource
    {
        ...
        public Ns(string name, NsArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:domains/v2:Ns", name, args ?? new NsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ns(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:domains/v2:Ns", name, null, MakeResourceOptions(options, id))
        {
        }
