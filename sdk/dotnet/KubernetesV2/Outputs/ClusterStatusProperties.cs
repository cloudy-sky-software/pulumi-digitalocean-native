...
namespace Pulumi.DigitalOceanNative.KubernetesV2.Outputs
{
    ...
    public sealed class ClusterStatusProperties
    {
        ...
        /// </summary>
        public readonly Pulumi.DigitalOceanNative.KubernetesV2.ClusterStatusPropertiesState? State;

        [OutputConstructor]
        private ClusterStatusProperties(
            string? message,

            Pulumi.DigitalOceanNative.KubernetesV2.ClusterStatusPropertiesState? state)
        {
            Message = message;
            State = state;
        }
