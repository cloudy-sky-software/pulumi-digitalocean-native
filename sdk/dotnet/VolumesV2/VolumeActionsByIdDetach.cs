...
{
    [DigitalOceanNativeResourceType("digitalocean-native:volumes/v2:VolumeActionsByIdDetach")]
    public partial class VolumeActionsByIdDetach : global::Pulumi.CustomResource
    {
        [Output("action")]
        ...
        public VolumeActionsByIdDetach(string name, VolumeActionsByIdDetachArgs args, CustomResourceOptions? options = null)
            : base("digitalocean-native:volumes/v2:VolumeActionsByIdDetach", name, args ?? new VolumeActionsByIdDetachArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeActionsByIdDetach(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:volumes/v2:VolumeActionsByIdDetach", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VolumeActionsByIdDetach Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new VolumeActionsByIdDetach(name, id, options);
        }
    }

    public sealed class VolumeActionsByIdDetachArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique identifier for the Droplet the volume will be attached or detached from.
        /// </summary>
        ...
        public VolumeActionsByIdDetachArgs()
        {
        }
        public static new VolumeActionsByIdDetachArgs Empty => new VolumeActionsByIdDetachArgs();
    }
}
