...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.Outputs
{
    ...
    public sealed class NetworkV6
    {
        ...
        /// </summary>
        public readonly CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.NetworkV6Type? Type;
        ...
        private NetworkV6(
            ...
            CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.NetworkV6Type? type)
        {
            Gateway = gateway;
            IpAddress = ipAddress;
            Netmask = netmask;
