...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.Outputs
{
    ...
    public sealed class NetworkV4
    {
        ...
        /// </summary>
        public readonly CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.NetworkV4Type? Type;
        ...
        private NetworkV4(
            ...
            CloudySkySoftware.Pulumi.DigitalOceanNative.FloatingIpsV2.NetworkV4Type? type)
        {
            Gateway = gateway;
            IpAddress = ipAddress;
            Netmask = netmask;
