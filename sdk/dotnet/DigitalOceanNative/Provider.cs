...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative
{
    ...
    /// </summary>
    [DigitalOceanNativeResourceType("pulumi:providers:digitalocean-native")]
    public partial class Provider : global::Pulumi.ProviderResource
    {
        ...
        public Provider(string name, ProviderArgs? args = null, CustomResourceOptions? options = null)
            : base("digitalocean-native", name, args ?? new ProviderArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public ProviderArgs()
        {
            ApiKey = Utilities.GetEnv("DIGITALOCEAN_NATIVE_APIKEY");
        }
