...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.ImagesV2
{
    ...
    public sealed class TransferArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.ImagesV2.TransferPropertiesRegion> Region { get; set; } = null!;

        /// <summary>
        /// The action to be taken on the image. Can be either `convert` or `transfer`.
        /// </summary>
        [Input("type", required: true)]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.ImagesV2.ImageActionBaseType> Type { get; set; } = null!;
