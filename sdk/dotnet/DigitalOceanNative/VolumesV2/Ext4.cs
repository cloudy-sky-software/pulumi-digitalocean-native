...
{
    [DigitalOceanNativeResourceType("digitalocean-native:volumes/v2:Ext4")]
    public partial class Ext4 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("region")]
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.VolumesV2.Ext4PropertiesRegion?> Region { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a Ext4 resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Ext4(string name, Ext4Args args, CustomResourceOptions? options = null)
            : base("digitalocean-native:volumes/v2:Ext4", name, args ?? new Ext4Args(), MakeResourceOptions(options, ""))
        {
        }

        private Ext4(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:volumes/v2:Ext4", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Ext4 Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Ext4(name, id, options);
        }
    }

    public sealed class Ext4Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A time value given in ISO8601 combined date and time format that represents when the block storage volume was created.
        /// </summary>
        ...
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.VolumesV2.Ext4PropertiesRegion> Region { get; set; } = null!;
        ...
        public static new Ext4Args Empty => new Ext4Args();
    }
}
