...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.LoadBalancersV2.Inputs
{
    ...
    public sealed class StickySessionsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.LoadBalancersV2.StickySessionsType>? Type { get; set; }

        public StickySessionsArgs()
        {
            Type = CloudySkySoftware.Pulumi.DigitalOceanNative.LoadBalancersV2.StickySessionsType.None;
        }
