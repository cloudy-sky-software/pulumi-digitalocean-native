...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.RegistryV2
{
    ...
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("region")]
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.RegistryV2.Region?> Region { get; private set; } = null!;
        ...
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.RegistryV2.SubscriptionTierSlug> SubscriptionTierSlug { get; private set; } = null!;
    ...
    public sealed class RegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("region")]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.RegistryV2.Region>? Region { get; set; }

        /// <summary>
        /// The slug of the subscription tier to sign up for. Valid values can be retrieved using the options endpoint.
        /// </summary>
        [Input("subscriptionTierSlug", required: true)]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.RegistryV2.SubscriptionTierSlug> SubscriptionTierSlug { get; set; } = null!;
