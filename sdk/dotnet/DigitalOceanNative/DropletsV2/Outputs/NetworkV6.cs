...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.DropletsV2.Outputs
{
    ...
    public sealed class NetworkV6
    {
        ...
        /// </summary>
        public readonly CloudySkySoftware.Pulumi.DigitalOceanNative.DropletsV2.NetworkV6Type? Type;
        ...
        private NetworkV6(
            ...
            CloudySkySoftware.Pulumi.DigitalOceanNative.DropletsV2.NetworkV6Type? type)
        {
            Gateway = gateway;
            IpAddress = ipAddress;
            Netmask = netmask;
