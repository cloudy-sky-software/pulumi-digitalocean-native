...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.AppsV2.Inputs
{
    ...
    public sealed class AppJobSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.AppsV2.AppJobSpecPropertiesKind>? Kind { get; set; }
        ...
        public AppJobSpecArgs()
        {
            ...
            Kind = CloudySkySoftware.Pulumi.DigitalOceanNative.AppsV2.AppJobSpecPropertiesKind.Unspecified;
        }
