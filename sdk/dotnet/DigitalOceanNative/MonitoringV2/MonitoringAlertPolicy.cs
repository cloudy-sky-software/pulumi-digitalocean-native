...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2
{
    ...
    public partial class MonitoringAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        [Output("compare")]
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Compare> Compare { get; private set; } = null!;
        ...
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Type> Type { get; private set; } = null!;

        [Output("value")]
        public Output<double> Value { get; private set; } = null!;

        [Output("window")]
        public Output<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Window> Window { get; private set; } = null!;
    ...
    public sealed class MonitoringAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Compare> Compare { get; set; } = null!;
        ...
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Type> Type { get; set; } = null!;

        [Input("value", required: true)]
        public Input<double> Value { get; set; } = null!;

        [Input("window", required: true)]
        public Input<CloudySkySoftware.Pulumi.DigitalOceanNative.MonitoringV2.Window> Window { get; set; } = null!;
