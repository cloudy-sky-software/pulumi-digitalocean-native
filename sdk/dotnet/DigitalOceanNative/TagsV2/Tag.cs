...
namespace CloudySkySoftware.Pulumi.DigitalOceanNative.TagsV2
{
    ...
    /// </summary>
    [DigitalOceanNativeResourceType("digitalocean-native:tags/v2:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tag")]
        public Output<Outputs.Tags?> TagValue { get; private set; } = null!;
        ...
        public Tag(string name, TagArgs? args = null, CustomResourceOptions? options = null)
            : base("digitalocean-native:tags/v2:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("digitalocean-native:tags/v2:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
