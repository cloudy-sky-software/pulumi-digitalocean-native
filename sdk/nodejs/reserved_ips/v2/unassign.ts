...
export class Unassign extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Unassign {
        return new Unassign(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:reserved_ips/v2:Unassign';

    /**
     * Returns true if the given object is an instance of Unassign.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Unassign {
     ...
     */
    constructor(name: string, args: UnassignArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Unassign.__pulumiType, name, resourceInputs, opts);
    }
}
