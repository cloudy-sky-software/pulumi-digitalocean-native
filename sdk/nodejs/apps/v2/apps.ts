...
export class Apps extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Apps {
        return new Apps(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:apps/v2:Apps';
    ...
    constructor(name: string, args: AppsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Apps.__pulumiType, name, resourceInputs, opts);
    }
}
