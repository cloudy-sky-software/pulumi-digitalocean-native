...
export class LoadBalancersForwardingRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LoadBalancersForwardingRule {
        return new LoadBalancersForwardingRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:load_balancers/v2:LoadBalancersForwardingRule';

    /**
     * Returns true if the given object is an instance of LoadBalancersForwardingRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LoadBalancersForwardingRule {
     ...
     */
    constructor(name: string, args: LoadBalancersForwardingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancersForwardingRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LoadBalancersForwardingRuleArgs {
