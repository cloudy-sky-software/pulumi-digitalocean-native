...
export class FirewallsRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallsRule {
        return new FirewallsRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:firewalls/v2:FirewallsRule';

    /**
     * Returns true if the given object is an instance of FirewallsRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallsRule {
     ...
     */
    constructor(name: string, args?: FirewallsRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallsRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallsRuleArgs {
    /**
