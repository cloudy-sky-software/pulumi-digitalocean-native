...
export class Firewalls extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Firewalls {
        return new Firewalls(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:firewalls/v2:Firewalls';

    /**
     * Returns true if the given object is an instance of Firewalls.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Firewalls {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Firewalls.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: FirewallsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Firewalls.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallsArgs {
    /**
     * A time value given in ISO8601 combined date and time format that represents when the firewall was created.
     */
