...
export class Ext4 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ext4 {
        return new Ext4(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:volumes/v2:Ext4';

    /**
     * Returns true if the given object is an instance of Ext4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ext4 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ext4.__pulumiType;
    }
     ...
     */
    declare public readonly region: pulumi.Output<enums.volumes.v2.Ext4PropertiesRegion | undefined>;
    /**
     ...
     */
    constructor(name: string, args: Ext4Args, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Ext4.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Ext4Args {
     ...
     * The slug identifier for the region where the resource will initially be  available.
     */
    region: pulumi.Input<enums.volumes.v2.Ext4PropertiesRegion>;
    /**
     * The size of the block storage volume in GiB (1024^3). This field does not apply  when creating a volume from a snapshot.
     */
