...
export class Convert extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Convert {
        return new Convert(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:images/v2:Convert';

    /**
     * Returns true if the given object is an instance of Convert.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Convert {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Convert.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ConvertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Convert.__pulumiType, name, resourceInputs, opts);
    }
}
