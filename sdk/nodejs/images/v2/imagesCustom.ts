...
export class ImagesCustom extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ImagesCustom {
        return new ImagesCustom(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:images/v2:ImagesCustom';

    /**
     * Returns true if the given object is an instance of ImagesCustom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImagesCustom {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImagesCustom.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: ImagesCustomArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ImagesCustom.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ImagesCustomArgs {
    /**
     * An optional free-form text field to describe an image.
     */
     ...
     * The slug identifier for the region where the resource will initially be  available.
     */
    region?: pulumi.Input<enums.images.v2.ImagesCustomPropertiesRegion>;
    /**
     * A flat array of tag names as strings to be applied to the resource. Tag names may be for either existing or new tags.
     */
