...
export class Reboot extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Reboot {
        return new Reboot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean-native:droplets/v2:Reboot';
     ...
     */
    public readonly type!: pulumi.Output<enums.droplets.v2.RebootType>;
    ...
    constructor(name: string, args: RebootArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Reboot.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface RebootArgs {
     ...
     * The type of action to initiate for the Droplet.
     */
    type: pulumi.Input<enums.droplets.v2.RebootType>;
}
