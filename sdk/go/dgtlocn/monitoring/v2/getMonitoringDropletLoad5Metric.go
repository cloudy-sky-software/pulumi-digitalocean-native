...
func (o GetMonitoringDropletLoad5MetricResultOutput) Items() MetricsOutput {
	return o.ApplyT(func(v GetMonitoringDropletLoad5MetricResult) Metrics { return v.Items }).(MetricsOutput)
}
