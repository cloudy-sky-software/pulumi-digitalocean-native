...
func NewUnassign(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("digitalocean-native:reserved_ips/v2:Unassign", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUnassign(ctx *pulumi.Context,
	...
	var resource Unassign
	err := ctx.ReadResource("digitalocean-native:reserved_ips/v2:Unassign", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The ID of the Droplet that the reserved IP will be unassigned from.
func (o UnassignOutput) DropletId() pulumi.IntOutput {
	return o.ApplyT(func(v *Unassign) pulumi.IntOutput { return v.DropletId }).(pulumi.IntOutput)
}
