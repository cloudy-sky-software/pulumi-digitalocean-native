...
type FloatingIpRegionOutput struct{ *pulumi.OutputState }

func (FloatingIpRegionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*FloatingIpRegion)(nil)).Elem()
}

func (o FloatingIpRegionOutput) ToFloatingIpRegionOutput() FloatingIpRegionOutput {
	return o
}

func (o FloatingIpRegionOutput) ToFloatingIpRegionOutputWithContext(ctx context.Context) FloatingIpRegionOutput {
	return o
}

// This is a boolean value that represents whether new Droplets can be created in this region.
func (o FloatingIpRegionOutput) Available() pulumi.BoolOutput {
	return o.ApplyT(func(v FloatingIpRegion) bool { return v.Available }).(pulumi.BoolOutput)
}

// This attribute is set to an array which contains features available in this region
func (o FloatingIpRegionOutput) Features() pulumi.StringArrayOutput {
	return o.ApplyT(func(v FloatingIpRegion) []string { return v.Features }).(pulumi.StringArrayOutput)
}

// The display name of the region.  This will be a full name that is used in the control panel and other interfaces.
func (o FloatingIpRegionOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v FloatingIpRegion) string { return v.Name }).(pulumi.StringOutput)
}

// This attribute is set to an array which contains the identifying slugs for the sizes available in this region.
func (o FloatingIpRegionOutput) Sizes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v FloatingIpRegion) []string { return v.Sizes }).(pulumi.StringArrayOutput)
}

// A human-readable string that is used as a unique identifier for each region.
func (o FloatingIpRegionOutput) Slug() pulumi.StringOutput {
	return o.ApplyT(func(v FloatingIpRegion) string { return v.Slug }).(pulumi.StringOutput)
}

type FloatingIpRegionPtrOutput struct{ *pulumi.OutputState }

func (FloatingIpRegionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**FloatingIpRegion)(nil)).Elem()
}

func (o FloatingIpRegionPtrOutput) ToFloatingIpRegionPtrOutput() FloatingIpRegionPtrOutput {
	return o
}

func (o FloatingIpRegionPtrOutput) ToFloatingIpRegionPtrOutputWithContext(ctx context.Context) FloatingIpRegionPtrOutput {
	return o
}

func (o FloatingIpRegionPtrOutput) Elem() FloatingIpRegionOutput {
	return o.ApplyT(func(v *FloatingIpRegion) FloatingIpRegion {
		if v != nil {
			return *v
		}
		var ret FloatingIpRegion
		return ret
	}).(FloatingIpRegionOutput)
}

// This is a boolean value that represents whether new Droplets can be created in this region.
func (o FloatingIpRegionPtrOutput) Available() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FloatingIpRegion) *bool {
		if v == nil {
			return nil
		}
		return &v.Available
...
// This attribute is set to an array which contains features available in this region
func (o FloatingIpRegionPtrOutput) Features() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *FloatingIpRegion) []string {
		if v == nil {
			return nil
		}
		return v.Features
...
// The display name of the region.  This will be a full name that is used in the control panel and other interfaces.
func (o FloatingIpRegionPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FloatingIpRegion) *string {
		if v == nil {
			return nil
		}
...
// This attribute is set to an array which contains the identifying slugs for the sizes available in this region.
func (o FloatingIpRegionPtrOutput) Sizes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *FloatingIpRegion) []string {
		if v == nil {
			return nil
		}
...
// A human-readable string that is used as a unique identifier for each region.
func (o FloatingIpRegionPtrOutput) Slug() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FloatingIpRegion) *string {
		if v == nil {
			return nil
		}
...
// Defaults sets the appropriate defaults for GetFloatingIPsActionProperties
func (val *GetFloatingIPsActionProperties) Defaults() *GetFloatingIPsActionProperties {
	if val == nil {
		return nil
	}
	tmp := *val
...
type GetFloatingIPsActionPropertiesOutput struct{ *pulumi.OutputState }

func (GetFloatingIPsActionPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetFloatingIPsActionProperties)(nil)).Elem()
}

func (o GetFloatingIPsActionPropertiesOutput) ToGetFloatingIPsActionPropertiesOutput() GetFloatingIPsActionPropertiesOutput {
	return o
}

func (o GetFloatingIPsActionPropertiesOutput) ToGetFloatingIPsActionPropertiesOutputWithContext(ctx context.Context) GetFloatingIPsActionPropertiesOutput {
	return o
}

func (o GetFloatingIPsActionPropertiesOutput) Action() GetFloatingIPsActionPropertiesActionPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionProperties) *GetFloatingIPsActionPropertiesAction { return v.Action }).(GetFloatingIPsActionPropertiesActionPtrOutput)
}

type GetFloatingIPsActionPropertiesAction struct {
	// A time value given in ISO8601 combined date and time format that represents when the action was completed.
	CompletedAt *string `pulumi:"completedAt"`
	// A unique numeric ID that can be used to identify and reference an action.
	Id *int `pulumi:"id"`
...
// Defaults sets the appropriate defaults for GetFloatingIPsActionPropertiesAction
func (val *GetFloatingIPsActionPropertiesAction) Defaults() *GetFloatingIPsActionPropertiesAction {
	if val == nil {
		return nil
	}
	tmp := *val
...
type GetFloatingIPsActionPropertiesActionOutput struct{ *pulumi.OutputState }

func (GetFloatingIPsActionPropertiesActionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetFloatingIPsActionPropertiesAction)(nil)).Elem()
}

func (o GetFloatingIPsActionPropertiesActionOutput) ToGetFloatingIPsActionPropertiesActionOutput() GetFloatingIPsActionPropertiesActionOutput {
	return o
}

func (o GetFloatingIPsActionPropertiesActionOutput) ToGetFloatingIPsActionPropertiesActionOutputWithContext(ctx context.Context) GetFloatingIPsActionPropertiesActionOutput {
	return o
}

// A time value given in ISO8601 combined date and time format that represents when the action was completed.
func (o GetFloatingIPsActionPropertiesActionOutput) CompletedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *string { return v.CompletedAt }).(pulumi.StringPtrOutput)
}

// A unique numeric ID that can be used to identify and reference an action.
func (o GetFloatingIPsActionPropertiesActionOutput) Id() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *int { return v.Id }).(pulumi.IntPtrOutput)
}

// The UUID of the project to which the reserved IP currently belongs.
func (o GetFloatingIPsActionPropertiesActionOutput) ProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *string { return v.ProjectId }).(pulumi.StringPtrOutput)
}

func (o GetFloatingIPsActionPropertiesActionOutput) Region() RegionPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *Region { return v.Region }).(RegionPtrOutput)
}

func (o GetFloatingIPsActionPropertiesActionOutput) RegionSlug() ActionRegionSlugPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *ActionRegionSlug { return v.RegionSlug }).(ActionRegionSlugPtrOutput)
}

// A unique identifier for the resource that the action is associated with.
func (o GetFloatingIPsActionPropertiesActionOutput) ResourceId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *int { return v.ResourceId }).(pulumi.IntPtrOutput)
}

// The type of resource that the action is associated with.
func (o GetFloatingIPsActionPropertiesActionOutput) ResourceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *string { return v.ResourceType }).(pulumi.StringPtrOutput)
}

// A time value given in ISO8601 combined date and time format that represents when the action was initiated.
func (o GetFloatingIPsActionPropertiesActionOutput) StartedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *string { return v.StartedAt }).(pulumi.StringPtrOutput)
}

// The current status of the action. This can be "in-progress", "completed", or "errored".
func (o GetFloatingIPsActionPropertiesActionOutput) Status() ActionStatusPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *ActionStatus { return v.Status }).(ActionStatusPtrOutput)
}

// This is the type of action that the object represents. For example, this could be "transfer" to represent the state of an image transfer action.
func (o GetFloatingIPsActionPropertiesActionOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFloatingIPsActionPropertiesAction) *string { return v.Type }).(pulumi.StringPtrOutput)
}

type GetFloatingIPsActionPropertiesActionPtrOutput struct{ *pulumi.OutputState }

func (GetFloatingIPsActionPropertiesActionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GetFloatingIPsActionPropertiesAction)(nil)).Elem()
}

func (o GetFloatingIPsActionPropertiesActionPtrOutput) ToGetFloatingIPsActionPropertiesActionPtrOutput() GetFloatingIPsActionPropertiesActionPtrOutput {
	return o
}

func (o GetFloatingIPsActionPropertiesActionPtrOutput) ToGetFloatingIPsActionPropertiesActionPtrOutputWithContext(ctx context.Context) GetFloatingIPsActionPropertiesActionPtrOutput {
	return o
}

func (o GetFloatingIPsActionPropertiesActionPtrOutput) Elem() GetFloatingIPsActionPropertiesActionOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) GetFloatingIPsActionPropertiesAction {
		if v != nil {
			return *v
		}
		var ret GetFloatingIPsActionPropertiesAction
		return ret
	}).(GetFloatingIPsActionPropertiesActionOutput)
}

// A time value given in ISO8601 combined date and time format that represents when the action was completed.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) CompletedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *string {
		if v == nil {
			return nil
		}
		return v.CompletedAt
...
// A unique numeric ID that can be used to identify and reference an action.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) Id() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *int {
		if v == nil {
			return nil
		}
		return v.Id
...
// The UUID of the project to which the reserved IP currently belongs.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) ProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *string {
		if v == nil {
			return nil
		}
...
func (o GetFloatingIPsActionPropertiesActionPtrOutput) Region() RegionPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *Region {
		if v == nil {
			return nil
		}
		return v.Region
...
func (o GetFloatingIPsActionPropertiesActionPtrOutput) RegionSlug() ActionRegionSlugPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *ActionRegionSlug {
		if v == nil {
			return nil
		}
		return v.RegionSlug
...
// A unique identifier for the resource that the action is associated with.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) ResourceId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *int {
		if v == nil {
			return nil
		}
...
// The type of resource that the action is associated with.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) ResourceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *string {
		if v == nil {
			return nil
		}
...
// A time value given in ISO8601 combined date and time format that represents when the action was initiated.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) StartedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *string {
		if v == nil {
			return nil
		}
...
// The current status of the action. This can be "in-progress", "completed", or "errored".
func (o GetFloatingIPsActionPropertiesActionPtrOutput) Status() ActionStatusPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *ActionStatus {
		if v == nil {
			return nil
		}
		return v.Status
...
// This is the type of action that the object represents. For example, this could be "transfer" to represent the state of an image transfer action.
func (o GetFloatingIPsActionPropertiesActionPtrOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GetFloatingIPsActionPropertiesAction) *string {
		if v == nil {
			return nil
		}
...
type ListFloatingIPs struct {
	FloatingIps []FloatingIp `pulumi:"floatingIps"`
	Links       *PageLinks   `pulumi:"links"`
	Meta        MetaMeta     `pulumi:"meta"`
}

type ListFloatingIPsOutput struct{ *pulumi.OutputState }

func (ListFloatingIPsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ListFloatingIPs)(nil)).Elem()
}

func (o ListFloatingIPsOutput) ToListFloatingIPsOutput() ListFloatingIPsOutput {
	return o
}

func (o ListFloatingIPsOutput) ToListFloatingIPsOutputWithContext(ctx context.Context) ListFloatingIPsOutput {
	return o
}

func (o ListFloatingIPsOutput) FloatingIps() FloatingIpArrayOutput {
	return o.ApplyT(func(v ListFloatingIPs) []FloatingIp { return v.FloatingIps }).(FloatingIpArrayOutput)
}

func (o ListFloatingIPsOutput) Links() PageLinksPtrOutput {
	return o.ApplyT(func(v ListFloatingIPs) *PageLinks { return v.Links }).(PageLinksPtrOutput)
}

func (o ListFloatingIPsOutput) Meta() MetaMetaOutput {
	return o.ApplyT(func(v ListFloatingIPs) MetaMeta { return v.Meta }).(MetaMetaOutput)
}

type ListFloatingIPsAction struct {
	Actions []Action   `pulumi:"actions"`
	Links   *PageLinks `pulumi:"links"`
	Meta    MetaMeta   `pulumi:"meta"`
}

type ListFloatingIPsActionOutput struct{ *pulumi.OutputState }

func (ListFloatingIPsActionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ListFloatingIPsAction)(nil)).Elem()
}

func (o ListFloatingIPsActionOutput) ToListFloatingIPsActionOutput() ListFloatingIPsActionOutput {
	return o
}

func (o ListFloatingIPsActionOutput) ToListFloatingIPsActionOutputWithContext(ctx context.Context) ListFloatingIPsActionOutput {
	return o
}

func (o ListFloatingIPsActionOutput) Actions() ActionArrayOutput {
	return o.ApplyT(func(v ListFloatingIPsAction) []Action { return v.Actions }).(ActionArrayOutput)
}

func (o ListFloatingIPsActionOutput) Links() PageLinksPtrOutput {
	return o.ApplyT(func(v ListFloatingIPsAction) *PageLinks { return v.Links }).(PageLinksPtrOutput)
}

func (o ListFloatingIPsActionOutput) Meta() MetaMetaOutput {
	return o.ApplyT(func(v ListFloatingIPsAction) MetaMeta { return v.Meta }).(MetaMetaOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ListFloatingIPsOutput{})
	pulumi.RegisterOutputType(ListFloatingIPsActionOutput{})
