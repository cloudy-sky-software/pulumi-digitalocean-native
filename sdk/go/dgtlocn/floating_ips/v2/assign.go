...
func NewAssign(ctx *pulumi.Context,
	...
	var resource Assign
	err := ctx.RegisterResource("digitalocean-native:floating_ips/v2:Assign", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssign(ctx *pulumi.Context,
	...
	var resource Assign
	err := ctx.ReadResource("digitalocean-native:floating_ips/v2:Assign", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
