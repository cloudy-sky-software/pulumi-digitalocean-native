...
func NewCname(ctx *pulumi.Context,
	...
	var resource Cname
	err := ctx.RegisterResource("digitalocean-native:domains/v2:Cname", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCname(ctx *pulumi.Context,
	...
	var resource Cname
	err := ctx.ReadResource("digitalocean-native:domains/v2:Cname", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Variable data depending on record type. For example, the "data" value for an A record would be the IPv4 address to which the domain will be mapped. For a CAA record, it would contain the domain name of the CA being granted permission to issue certificates.
func (o CnameOutput) Data() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.StringPtrOutput { return v.Data }).(pulumi.StringPtrOutput)
}

func (o CnameOutput) DomainRecord() DomainRecordPtrOutput {
	return o.ApplyT(func(v *Cname) DomainRecordPtrOutput { return v.DomainRecord }).(DomainRecordPtrOutput)
}

// An unsigned integer between 0-255 used for CAA records.
func (o CnameOutput) Flags() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.IntPtrOutput { return v.Flags }).(pulumi.IntPtrOutput)
}
...
// The port for SRV records.
func (o CnameOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.IntPtrOutput { return v.Port }).(pulumi.IntPtrOutput)
}

// The priority for SRV and MX records.
func (o CnameOutput) Priority() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.IntPtrOutput { return v.Priority }).(pulumi.IntPtrOutput)
}

// The parameter tag for CAA records. Valid values are "issue", "issuewild", or "iodef"
func (o CnameOutput) Tag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.StringPtrOutput { return v.Tag }).(pulumi.StringPtrOutput)
}
...
// The type of the DNS record. For example: A, CNAME, TXT, ...
func (o CnameOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.StringPtrOutput { return v.Type }).(pulumi.StringPtrOutput)
}

// The weight for SRV records.
func (o CnameOutput) Weight() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Cname) pulumi.IntPtrOutput { return v.Weight }).(pulumi.IntPtrOutput)
}
