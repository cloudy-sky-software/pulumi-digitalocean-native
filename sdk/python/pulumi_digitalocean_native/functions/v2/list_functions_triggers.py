...
def list_functions_triggers(namespace_id: Optional[_builtins.str] = None,
...
def list_functions_triggers_output(namespace_id: Optional[pulumi.Input[_builtins.str]] = None,
