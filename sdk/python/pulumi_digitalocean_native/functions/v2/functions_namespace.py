...
class FunctionsNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] label: The namespace's unique name.
        :param pulumi.Input[builtins.str] region: The [datacenter region](https://docs.digitalocean.com/products/platform/availability-matrix/#available-datacenters) in which to create the namespace.
        """
