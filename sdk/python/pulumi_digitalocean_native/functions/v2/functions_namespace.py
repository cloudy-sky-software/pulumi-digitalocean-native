...
class FunctionsNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: The namespace's unique name.
        :param pulumi.Input[_builtins.str] region: The [datacenter region](https://docs.digitalocean.com/products/platform/availability-matrix/#available-datacenters) in which to create the namespace.
        """
...
@pulumi.type_token("digitalocean-native:functions/v2:FunctionsNamespace")
