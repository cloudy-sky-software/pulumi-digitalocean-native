...
class FunctionsTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function: Name of function(action) that exists in the given namespace.
        :param pulumi.Input[builtins.bool] is_enabled: Indicates weather the trigger is paused or unpaused.
        :param pulumi.Input['ScheduledDetailsArgs'] scheduled_details: Trigger details for SCHEDULED type, where body is optional.
        :param pulumi.Input[builtins.str] type: One of different type of triggers. Currently only SCHEDULED is supported.
        :param pulumi.Input[builtins.str] name: The trigger's unique name within the namespace.
        :param pulumi.Input[builtins.str] namespace_id: The ID of the namespace to be managed.
        """
