...
def get_functions_trigger(namespace_id: Optional[builtins.str] = None,
    ...
    :param builtins.str trigger_name: The name of the trigger to be managed.
    """
    __args__ = dict()
...
def get_functions_trigger_output(namespace_id: Optional[pulumi.Input[builtins.str]] = None,
