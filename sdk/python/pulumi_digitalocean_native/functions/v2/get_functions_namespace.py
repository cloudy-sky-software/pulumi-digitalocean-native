...
def get_functions_namespace(namespace_id: Optional[_builtins.str] = None,
...
def get_functions_namespace_output(namespace_id: Optional[pulumi.Input[_builtins.str]] = None,
