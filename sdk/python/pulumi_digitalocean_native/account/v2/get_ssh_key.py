...
def get_ssh_key(ssh_key_identifier: Optional[_builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSshKeyProperties:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str ssh_key_identifier: Either the ID or the fingerprint of an existing SSH key.
    """
    __args__ = dict()
...
def get_ssh_key_output(ssh_key_identifier: Optional[pulumi.Input[_builtins.str]] = None,
