...
class SshKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] public_key: The entire public key string that was uploaded. Embedded into the root user's `authorized_keys` file if you include this key during Droplet creation.
        :param pulumi.Input[builtins.str] name: A human-readable display name for this key, used to easily identify the SSH keys when they are displayed.
        """
