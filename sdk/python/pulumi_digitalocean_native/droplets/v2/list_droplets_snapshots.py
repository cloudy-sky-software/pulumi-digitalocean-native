...
def list_droplets_snapshots(droplet_id: Optional[_builtins.str] = None,
...
def list_droplets_snapshots_output(droplet_id: Optional[pulumi.Input[_builtins.str]] = None,
