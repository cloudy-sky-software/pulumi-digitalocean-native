...
class RestoreArgs:
    def __init__(__self__, *,
                 ...
                 image: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] image: The ID of a backup of the current Droplet instance to restore from.
        """
    ...
    @property
    @pulumi.getter
    def image(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @image.setter
    def image(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Restore(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def image(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ID of a backup of the current Droplet instance to restore from.
        """
        return pulumi.get(self, "image")
