...
class RestoreArgs:
    def __init__(__self__, *,
                 ...
                 image: Optional[pulumi.Input[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.int] image: The ID of a backup of the current Droplet instance to restore from.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def image(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @image.setter
    def image(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "image", value)


@pulumi.type_token("digitalocean-native:droplets/v2:Restore")
class Restore(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def image(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The ID of a backup of the current Droplet instance to restore from.
        """
        return pulumi.get(self, "image")
