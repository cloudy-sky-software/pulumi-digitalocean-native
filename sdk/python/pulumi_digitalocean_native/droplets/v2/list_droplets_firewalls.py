...
def list_droplets_firewalls(droplet_id: Optional[_builtins.str] = None,
...
def list_droplets_firewalls_output(droplet_id: Optional[pulumi.Input[_builtins.str]] = None,
