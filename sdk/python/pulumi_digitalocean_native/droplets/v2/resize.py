...
class ResizeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disk: When `true`, the Droplet's disk will be resized in addition to its RAM and CPU. This is a permanent change and cannot be reversed as a Droplet's disk size cannot be decreased.
        :param pulumi.Input[_builtins.str] droplet_id: A unique identifier for a Droplet instance.
        :param pulumi.Input[_builtins.str] size: The slug identifier for the size to which you wish to resize the Droplet.
        """
...
@pulumi.type_token("digitalocean-native:droplets/v2:Resize")
class Resize(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def disk(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When `true`, the Droplet's disk will be resized in addition to its RAM and CPU. This is a permanent change and cannot be reversed as a Droplet's disk size cannot be decreased.
        """
        return pulumi.get(self, "disk")
