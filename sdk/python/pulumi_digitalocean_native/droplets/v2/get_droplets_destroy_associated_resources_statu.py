...
def get_droplets_destroy_associated_resources_statu(droplet_id: Optional[builtins.str] = None,
...
def get_droplets_destroy_associated_resources_statu_output(droplet_id: Optional[pulumi.Input[builtins.str]] = None,
