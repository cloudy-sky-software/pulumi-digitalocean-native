...
def get_droplets_destroy_associated_resources_statu(droplet_id: Optional[_builtins.str] = None,
...
def get_droplets_destroy_associated_resources_statu_output(droplet_id: Optional[pulumi.Input[_builtins.str]] = None,
