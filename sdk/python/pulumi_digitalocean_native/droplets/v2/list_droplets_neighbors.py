...
def list_droplets_neighbors(droplet_id: Optional[_builtins.str] = None,
...
def list_droplets_neighbors_output(droplet_id: Optional[pulumi.Input[_builtins.str]] = None,
