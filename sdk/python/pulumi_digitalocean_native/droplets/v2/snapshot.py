...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name to give the new snapshot of the Droplet.
        """
...
@pulumi.type_token("digitalocean-native:droplets/v2:Snapshot")
class Snapshot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Snapshot, __self__).__init__(
            'digitalocean-native:droplets/v2:Snapshot',
            resource_name,
            __props__,
            opts)
