...
class DropletArgs:
    def __init__(__self__, *,
                 image: pulumi.Input[Union[_builtins.str, _builtins.int]],
                 ...
                 ssh_keys: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, _builtins.int]]]]] = None,
        ...
        :param pulumi.Input[Union[_builtins.str, _builtins.int]] image: The image ID of a public or private image or the slug identifier for a public image. This image will be the base image for your Droplet.
        :param pulumi.Input[_builtins.str] name: The human-readable string you wish to use when displaying the Droplet name. The name, if set to a domain name managed in the DigitalOcean DNS management system, will configure a PTR record for the Droplet. The name set during creation will also determine the hostname for the Droplet in its internal configuration.
        :param pulumi.Input[_builtins.str] size: The slug identifier for the size that you wish to select for this Droplet.
        :param pulumi.Input[_builtins.bool] backups: A boolean indicating whether automated backups should be enabled for the Droplet.
        :param pulumi.Input[_builtins.bool] ipv6: A boolean indicating whether to enable IPv6 on the Droplet.
        :param pulumi.Input[_builtins.bool] monitoring: A boolean indicating whether to install the DigitalOcean agent for monitoring.
        :param pulumi.Input[_builtins.bool] private_networking: This parameter has been deprecated. Use `vpc_uuid` instead to specify a VPC network for the Droplet. If no `vpc_uuid` is provided, the Droplet will be placed in your account's default VPC for the region.
        :param pulumi.Input[_builtins.str] region: The slug identifier for the region that you wish to deploy the Droplet in. If the specific datacenter is not not important, a slug prefix (e.g. `nyc`) can be used to deploy the Droplet in any of the that region's locations (`nyc1`, `nyc2`, or `nyc3`). If the region is omitted from the create request completely, the Droplet may deploy in any region.
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, _builtins.int]]]] ssh_keys: An array containing the IDs or fingerprints of the SSH keys that you wish to embed in the Droplet's root account upon creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A flat array of tag names as strings to apply to the Droplet after it is created. Tag names can either be existing or new tags.
        :param pulumi.Input[_builtins.str] user_data: A string containing 'user data' which may be used to configure the Droplet on first boot, often a 'cloud-config' file or Bash script. It must be plain text and may not exceed 64 KiB in size.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] volumes: An array of IDs for block storage volumes that will be attached to the Droplet once created. The volumes must not already be attached to an existing Droplet.
        :param pulumi.Input[_builtins.str] vpc_uuid: A string specifying the UUID of the VPC to which the Droplet will be assigned. If excluded, the Droplet will be assigned to your account's default VPC for the region.
        :param pulumi.Input[_builtins.bool] with_droplet_agent: A boolean indicating whether to install the DigitalOcean agent used for providing access to the Droplet web console in the control panel. By default, the agent is installed on new Droplets but installation errors (i.e. OS not supported) are ignored. To prevent it from being installed, set to `false`. To make installation errors fatal, explicitly set it to `true`.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def image(self) -> pulumi.Input[Union[_builtins.str, _builtins.int]]:
        """
    ...
    @image.setter
    def image(self, value: pulumi.Input[Union[_builtins.str, _builtins.int]]):
    ...
    def ssh_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, _builtins.int]]]]]:
        """
    ...
    @ssh_keys.setter
    def ssh_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, _builtins.int]]]]]):
...
@pulumi.type_token("digitalocean-native:droplets/v2:Droplet")
class Droplet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 backups: Optional[pulumi.Input[_builtins.bool]] = None,
                 image: Optional[pulumi.Input[Union[_builtins.str, _builtins.int]]] = None,
                 ipv6: Optional[pulumi.Input[_builtins.bool]] = None,
                 monitoring: Optional[pulumi.Input[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="privateNetworking")
    def private_networking(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        This parameter has been deprecated. Use `vpc_uuid` instead to specify a VPC network for the Droplet. If no `vpc_uuid` is provided, the Droplet will be placed in your account's default VPC for the region.
        """
        return pulumi.get(self, "private_networking")
    ...
    @_builtins.property
    @pulumi.getter(name="withDropletAgent")
    def with_droplet_agent(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        A boolean indicating whether to install the DigitalOcean agent used for providing access to the Droplet web console in the control panel. By default, the agent is installed on new Droplets but installation errors (i.e. OS not supported) are ignored. To prevent it from being installed, set to `false`. To make installation errors fatal, explicitly set it to `true`.
        """
        return pulumi.get(self, "with_droplet_agent")
