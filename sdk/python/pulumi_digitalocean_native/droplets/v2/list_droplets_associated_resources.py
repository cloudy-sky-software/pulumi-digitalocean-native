...
def list_droplets_associated_resources(droplet_id: Optional[_builtins.str] = None,
...
def list_droplets_associated_resources_output(droplet_id: Optional[pulumi.Input[_builtins.str]] = None,
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListDropletsAssociatedResourcesItems]:
    """
    Use this data source to access information about an existing resource.
