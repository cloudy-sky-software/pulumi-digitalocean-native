...
def list_droplets_associated_resources(droplet_id: Optional[builtins.str] = None,
...
def list_droplets_associated_resources_output(droplet_id: Optional[pulumi.Input[builtins.str]] = None,
