...
class ChangeKernelArgs:
    def __init__(__self__, *,
                 ...
                 kernel: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] kernel: A unique number used to identify and reference a specific kernel.
        """
    ...
    @property
    @pulumi.getter
    def kernel(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @kernel.setter
    def kernel(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ChangeKernel(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def kernel(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        A unique number used to identify and reference a specific kernel.
        """
        return pulumi.get(self, "kernel")
