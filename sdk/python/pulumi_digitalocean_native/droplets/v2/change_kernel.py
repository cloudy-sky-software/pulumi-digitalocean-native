...
class ChangeKernelArgs:
    def __init__(__self__, *,
                 ...
                 kernel: Optional[pulumi.Input[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.int] kernel: A unique number used to identify and reference a specific kernel.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kernel(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @kernel.setter
    def kernel(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "kernel", value)


@pulumi.type_token("digitalocean-native:droplets/v2:ChangeKernel")
class ChangeKernel(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def kernel(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        A unique number used to identify and reference a specific kernel.
        """
        return pulumi.get(self, "kernel")
