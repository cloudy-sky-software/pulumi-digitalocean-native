...
@pulumi.output_type
class AssociatedResource(dict):
    """
    An objects containing information about a resource associated with a Droplet.
    """
    def __init__(__self__, *,
                 cost: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None):
        """
        An objects containing information about a resource associated with a Droplet.
        :param builtins.str cost: The cost of the resource in USD per month if the resource is retained after the Droplet is destroyed.
        :param builtins.str id: The unique identifier for the resource associated with the Droplet.
        :param builtins.str name: The name of the resource associated with the Droplet.
        """
        if cost is not None:
    ...
    @property
    @pulumi.getter
    def cost(self) -> Optional[builtins.str]:
        """
...
@pulumi.output_type
class AssociatedResourceStatusResourcesProperties(dict):
    """
    An object containing additional information about resource related to a Droplet requested to be destroyed.
    """
    def __init__(__self__, *,
                 floating_ips: Optional[Sequence['outputs.DestroyedAssociatedResource']] = None,
                 reserved_ips: Optional[Sequence['outputs.DestroyedAssociatedResource']] = None,
                 snapshots: Optional[Sequence['outputs.DestroyedAssociatedResource']] = None,
                 volume_snapshots: Optional[Sequence['outputs.DestroyedAssociatedResource']] = None,
                 volumes: Optional[Sequence['outputs.DestroyedAssociatedResource']] = None):
        """
        An object containing additional information about resource related to a Droplet requested to be destroyed.
        """
    ...
    def floating_ips(self) -> Optional[Sequence['outputs.DestroyedAssociatedResource']]:
        return pulumi.get(self, "floating_ips")

    @property
    @pulumi.getter(name="reservedIps")
    def reserved_ips(self) -> Optional[Sequence['outputs.DestroyedAssociatedResource']]:
        return pulumi.get(self, "reserved_ips")

    @property
    @pulumi.getter
    def snapshots(self) -> Optional[Sequence['outputs.DestroyedAssociatedResource']]:
        return pulumi.get(self, "snapshots")

    @property
    @pulumi.getter(name="volumeSnapshots")
    def volume_snapshots(self) -> Optional[Sequence['outputs.DestroyedAssociatedResource']]:
        return pulumi.get(self, "volume_snapshots")

    @property
    @pulumi.getter
    def volumes(self) -> Optional[Sequence['outputs.DestroyedAssociatedResource']]:
        return pulumi.get(self, "volumes")


@pulumi.output_type
class DestroyedAssociatedResource(dict):
    """
    An object containing information about a resource scheduled for deletion.
    """
    def __init__(__self__, *,
                 destroyed_at: Optional[builtins.str] = None,
                 error_message: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None):
        """
        An object containing information about a resource scheduled for deletion.
        :param builtins.str destroyed_at: A time value given in ISO8601 combined date and time format indicating when the resource was destroyed if the request was successful.
        :param builtins.str error_message: A string indicating that the resource was not successfully destroyed and providing additional information.
        :param builtins.str id: The unique identifier for the resource scheduled for deletion.
        :param builtins.str name: The name of the resource scheduled for deletion.
        """
    ...
    def destroyed_at(self) -> Optional[builtins.str]:
        """
...
class DropletSnapshot(dict):
    def __init__(__self__, *,
                 ...
                 type: 'DropletSnapshotPropertiesType'):
        """
        ...
        :param 'DropletSnapshotPropertiesType' type: Describes the kind of image. It may be one of `snapshot` or `backup`. This specifies whether an image is a user-generated Droplet snapshot or automatically created Droplet backup.
        """
        pulumi.set(__self__, "created_at", created_at)
    ...
    @property
    @pulumi.getter
    def type(self) -> 'DropletSnapshotPropertiesType':
        """
...
class Firewall(dict):
    def __init__(__self__, *,
                 ...
                 droplet_ids: Optional[Sequence[builtins.int]] = None,
                 id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the firewall was created.
        :param Sequence[builtins.int] droplet_ids: An array containing the IDs of the Droplets assigned to the firewall.
        :param builtins.str id: A unique ID that can be used to identify and reference a firewall.
        :param builtins.str name: A human-readable name for a firewall. The name must begin with an alphanumeric character. Subsequent characters must either be alphanumeric characters, a period (.), or a dash (-).
    ...
    def droplet_ids(self) -> Optional[Sequence[builtins.int]]:
        """
...
class FirewallRulesInboundRulesItem(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ports: The ports on which traffic will be allowed specified as a string containing a single port, a range (e.g. "8000-9000"), or "0" when all ports are open for a protocol. For ICMP rules this parameter will always return "0".
