...
class DomainsRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of the DNS record. For example: A, CNAME, TXT, ...
        :param pulumi.Input[_builtins.str] data: Variable data depending on record type. For example, the "data" value for an A record would be the IPv4 address to which the domain will be mapped. For a CAA record, it would contain the domain name of the CA being granted permission to issue certificates.
        :param pulumi.Input[_builtins.str] domain_name: The name of the domain itself.
        :param pulumi.Input[_builtins.int] flags: An unsigned integer between 0-255 used for CAA records.
        :param pulumi.Input[_builtins.str] name: The host name, alias, or service being defined by the record.
        :param pulumi.Input[_builtins.int] port: The port for SRV records.
        :param pulumi.Input[_builtins.int] priority: The priority for SRV and MX records.
        :param pulumi.Input[_builtins.str] tag: The parameter tag for CAA records. Valid values are "issue", "issuewild", or "iodef"
        :param pulumi.Input[_builtins.int] ttl: This value is the time to live for the record, in seconds. This defines the time frame that clients can cache queried information before a refresh should be requested.
        :param pulumi.Input[_builtins.int] weight: The weight for SRV records.
        """
...
@pulumi.type_token("digitalocean-native:domains/v2:DomainsRecord")
