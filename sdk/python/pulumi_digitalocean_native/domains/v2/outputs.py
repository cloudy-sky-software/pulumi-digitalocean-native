...
class Domain(dict):
    ...
    def __init__(__self__, *,
                 ...
                 zone_file: Optional[_builtins.str] = None):
        """
        :param _builtins.str ip_address: This optional attribute may contain an IP address. When provided, an A record will be automatically created pointing to the apex domain.
        :param _builtins.str name: The name of the domain itself. This should follow the standard domain format of domain.TLD. For instance, `example.com` is a valid domain name.
        :param _builtins.int ttl: This value is the time to live for the records on this domain, in seconds. This defines the time frame that clients can cache queried information before a refresh should be requested.
        :param _builtins.str zone_file: This attribute contains the complete contents of the zone file for the selected domain. Individual domain record resources should be used to get more granular control over records. However, this attribute can also be used to get information about the SOA record, which is created automatically and is not accessible as an individual record resource.
        """
    ...
    def zone_file(self) -> Optional[_builtins.str]:
        """
...
class DomainRecord(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The type of the DNS record. For example: A, CNAME, TXT, ...
        :param _builtins.str data: Variable data depending on record type. For example, the "data" value for an A record would be the IPv4 address to which the domain will be mapped. For a CAA record, it would contain the domain name of the CA being granted permission to issue certificates.
        :param _builtins.int flags: An unsigned integer between 0-255 used for CAA records.
        :param _builtins.int id: A unique identifier for each domain record.
        :param _builtins.str name: The host name, alias, or service being defined by the record.
        :param _builtins.int port: The port for SRV records.
        :param _builtins.int priority: The priority for SRV and MX records.
        :param _builtins.str tag: The parameter tag for CAA records. Valid values are "issue", "issuewild", or "iodef"
