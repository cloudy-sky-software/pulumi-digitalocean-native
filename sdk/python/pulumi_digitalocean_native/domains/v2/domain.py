...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_address: This optional attribute may contain an IP address. When provided, an A record will be automatically created pointing to the apex domain.
        :param pulumi.Input[_builtins.str] name: The name of the domain itself. This should follow the standard domain format of domain.TLD. For instance, `example.com` is a valid domain name.
        """
...
@pulumi.type_token("digitalocean-native:domains/v2:Domain")
class Domain(pulumi.CustomResource):
    ...
    def zone_file(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
