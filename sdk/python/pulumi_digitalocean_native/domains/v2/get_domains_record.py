...
def get_domains_record(domain_name: Optional[_builtins.str] = None,
                       domain_record_id: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsRecordProperties:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str domain_name: The name of the domain itself.
    :param _builtins.str domain_record_id: The unique identifier of the domain record.
    """
    __args__ = dict()
...
def get_domains_record_output(domain_name: Optional[pulumi.Input[_builtins.str]] = None,
                              domain_record_id: Optional[pulumi.Input[_builtins.str]] = None,
