...
class VolumeSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: A human-readable name for the volume snapshot.
...
@pulumi.type_token("digitalocean-native:volumes/v2:VolumeSnapshot")
class VolumeSnapshot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VolumeSnapshot, __self__).__init__(
            'digitalocean-native:volumes/v2:VolumeSnapshot',
            resource_name,
            __props__,
            opts)
