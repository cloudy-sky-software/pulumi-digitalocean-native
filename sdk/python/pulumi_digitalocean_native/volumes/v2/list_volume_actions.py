...
def list_volume_actions(volume_id: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListVolumeActionsItems:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str volume_id: The ID of the block storage volume.
    """
    __args__ = dict()
...
def list_volume_actions_output(volume_id: Optional[pulumi.Input[_builtins.str]] = None,
