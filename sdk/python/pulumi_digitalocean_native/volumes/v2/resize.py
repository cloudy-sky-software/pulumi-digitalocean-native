...
class ResizeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] size_gigabytes: The new size of the block storage volume in GiB (1024^3).
...
@pulumi.type_token("digitalocean-native:volumes/v2:Resize")
