...
class ResizeArgs:
    def __init__(__self__, *,
                 size_gigabytes: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] size_gigabytes: The new size of the block storage volume in GiB (1024^3).
    ...
    def size_gigabytes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def size_gigabytes(self, value: pulumi.Input[builtins.int]):
