...
def get_volume_snapshots_by_id(snapshot_id: Optional[_builtins.str] = None,
...
def get_volume_snapshots_by_id_output(snapshot_id: Optional[pulumi.Input[_builtins.str]] = None,
