...
class AttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] droplet_id: The unique identifier for the Droplet the volume will be attached or detached from.
        ...
        :param pulumi.Input[builtins.str] volume_id: The ID of the block storage volume.
        """
