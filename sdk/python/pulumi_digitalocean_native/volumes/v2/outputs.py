...
class VolumeFull(dict):
    ...
    def __init__(__self__, *,
                 ...
                 filesystem_label: Optional[builtins.str] = None,
                 filesystem_type: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 region: Optional['outputs.VolumeFullPropertiesRegion'] = None,
                 size_gigabytes: Optional[builtins.int] = None,
                 tags: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the block storage volume was created.
        :param builtins.str description: An optional free-form text field to describe a block storage volume.
        :param Sequence[builtins.int] droplet_ids: An array containing the IDs of the Droplets the volume is attached to. Note that at this time, a volume can only be attached to a single Droplet.
        :param builtins.str filesystem_label: The label currently applied to the filesystem.
        :param builtins.str filesystem_type: The type of filesystem currently in-use on the volume.
        :param builtins.str id: The unique identifier for the block storage volume.
        :param builtins.str name: A human-readable name for the block storage volume. Must be lowercase and be composed only of numbers, letters and "-", up to a limit of 64 characters. The name must begin with a letter.
        :param builtins.int size_gigabytes: The size of the block storage volume in GiB (1024^3). This field does not apply  when creating a volume from a snapshot.
    ...
    def filesystem_label(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sizeGigabytes")
    def size_gigabytes(self) -> Optional[builtins.int]:
        """
