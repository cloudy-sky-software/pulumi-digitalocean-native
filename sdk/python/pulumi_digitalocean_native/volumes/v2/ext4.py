...
class Ext4Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the block storage volume was created.
        :param pulumi.Input[_builtins.str] description: An optional free-form text field to describe a block storage volume.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] droplet_ids: An array containing the IDs of the Droplets the volume is attached to. Note that at this time, a volume can only be attached to a single Droplet.
        :param pulumi.Input[_builtins.str] filesystem_type: The name of the filesystem type to be used on the volume. When provided, the volume will automatically be formatted to the specified filesystem type. Currently, the available options are `ext4` and `xfs`. Pre-formatted volumes are automatically mounted when attached to Ubuntu, Debian, Fedora, Fedora Atomic, and CentOS Droplets created on or after April 26, 2018. Attaching pre-formatted volumes to other Droplets is not recommended.
        :param pulumi.Input[_builtins.str] name: A human-readable name for the block storage volume. Must be lowercase and be composed only of numbers, letters and "-", up to a limit of 64 characters. The name must begin with a letter.
        :param pulumi.Input[_builtins.int] size_gigabytes: The size of the block storage volume in GiB (1024^3). This field does not apply  when creating a volume from a snapshot.
        :param pulumi.Input[_builtins.str] snapshot_id: The unique identifier for the volume snapshot from which to create the volume.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A flat array of tag names as strings to be applied to the resource. Tag names may be for either existing or new tags.
        """
...
@pulumi.type_token("digitalocean-native:volumes/v2:Ext4")
class Ext4(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="filesystemLabel")
    def filesystem_label(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "filesystem_label")

    @_builtins.property
    @pulumi.getter(name="filesystemType")
    def filesystem_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the filesystem type to be used on the volume. When provided, the volume will automatically be formatted to the specified filesystem type. Currently, the available options are `ext4` and `xfs`. Pre-formatted volumes are automatically mounted when attached to Ubuntu, Debian, Fedora, Fedora Atomic, and CentOS Droplets created on or after April 26, 2018. Attaching pre-formatted volumes to other Droplets is not recommended.
        """
        return pulumi.get(self, "filesystem_type")
    ...
    @_builtins.property
    @pulumi.getter(name="sizeGigabytes")
    def size_gigabytes(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The size of the block storage volume in GiB (1024^3). This field does not apply  when creating a volume from a snapshot.
        """
        return pulumi.get(self, "size_gigabytes")
