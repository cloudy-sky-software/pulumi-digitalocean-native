...
def list_projects_resources(project_id: Optional[_builtins.str] = None,
...
def list_projects_resources_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
