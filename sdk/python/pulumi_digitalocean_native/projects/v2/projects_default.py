...
class ProjectsDefaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the project was created.
        :param pulumi.Input[_builtins.str] description: The description of the project. The maximum length is 255 characters.
        :param pulumi.Input['ProjectBaseEnvironment'] environment: The environment of the project's resources.
        :param pulumi.Input[_builtins.bool] is_default: If true, all resources will be added to this project if no project is specified.
        :param pulumi.Input[_builtins.str] name: The human-readable name for the project. The maximum length is 175 characters and the name must be unique.
        :param pulumi.Input[_builtins.int] owner_id: The integer id of the project owner.
        :param pulumi.Input[_builtins.str] owner_uuid: The unique universal identifier of the project owner.
        :param pulumi.Input[_builtins.str] purpose: The purpose of the project. The maximum length is 255 characters. It can
        ...
        :param pulumi.Input[_builtins.str] updated_at: A time value given in ISO8601 combined date and time format that represents when the project was updated.
        """
...
@pulumi.type_token("digitalocean-native:projects/v2:ProjectsDefault")
class ProjectsDefault(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="ownerId")
    def owner_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The integer id of the project owner.
        """
        return pulumi.get(self, "owner_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ownerUuid")
    def owner_uuid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The unique universal identifier of the project owner.
        """
        return pulumi.get(self, "owner_uuid")
