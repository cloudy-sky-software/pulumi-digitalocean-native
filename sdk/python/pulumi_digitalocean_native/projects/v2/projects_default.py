...
class ProjectsDefaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the project was created.
        :param pulumi.Input[builtins.str] description: The description of the project. The maximum length is 255 characters.
        :param pulumi.Input['ProjectBaseEnvironment'] environment: The environment of the project's resources.
        :param pulumi.Input[builtins.bool] is_default: If true, all resources will be added to this project if no project is specified.
        :param pulumi.Input[builtins.str] name: The human-readable name for the project. The maximum length is 175 characters and the name must be unique.
        :param pulumi.Input[builtins.int] owner_id: The integer id of the project owner.
        :param pulumi.Input[builtins.str] owner_uuid: The unique universal identifier of the project owner.
        :param pulumi.Input[builtins.str] purpose: The purpose of the project. The maximum length is 255 characters. It can
        ...
        :param pulumi.Input[builtins.str] updated_at: A time value given in ISO8601 combined date and time format that represents when the project was updated.
        """
...
class ProjectsDefault(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ownerId")
    def owner_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The integer id of the project owner.
        """
        return pulumi.get(self, "owner_id")
    ...
    @property
    @pulumi.getter(name="ownerUuid")
    def owner_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique universal identifier of the project owner.
        """
        return pulumi.get(self, "owner_uuid")
