...
class AppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: The ID of the project the app should be assigned to. If omitted, it will be assigned to your default project.
        """
...
@pulumi.type_token("digitalocean-native:apps/v2:App")
