...
class AppAlertSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] disabled: Is the alert disabled?
        :param pulumi.Input[_builtins.float] value: Threshold value for alert
        """
...
class AppDatabaseSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name. Must be unique across all components within the same app.
...
class AppDomainSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] domain: The hostname for the domain
        ...
        :param pulumi.Input['AppDomainSpecType'] type: - DEFAULT: The default `.ondigitalocean.app` domain assigned to this app
               - PRIMARY: The primary domain for this app that is displayed as the default in the control panel, used in bindable environment variables, and any other places that reference an app's live URL. Only one domain may be set as primary.
               - ALIAS: A non-primary domain
        :param pulumi.Input[_builtins.bool] wildcard: Indicates whether the domain includes all sub-domains, in addition to the given domain
        :param pulumi.Input[_builtins.str] zone: Optional. If the domain uses DigitalOcean DNS and you would like App
               Platform to automatically manage it for you, set this to the name of the
               domain on your account.
...
class AppFunctionsSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class AppIngressSpecRuleRoutingComponentArgsDict(TypedDict):
        ...
        """
        preserve_path_prefix: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class AppIngressSpecRuleRoutingComponentArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[_builtins.str],
                 preserve_path_prefix: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] preserve_path_prefix: An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`. Note: this is not applicable for Functions Components and is mutually exclusive with `rewrite`.
        :param pulumi.Input[_builtins.str] rewrite: An optional field that will rewrite the path of the component to be what is specified here. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If you specified the rewrite to be `/v1/`, requests to `/api/list` would be rewritten to `/v1/list`. Note: this is mutually exclusive with `preserve_path_prefix`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def preserve_path_prefix(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`. Note: this is not applicable for Functions Components and is mutually exclusive with `rewrite`.
        """
    ...
    def preserve_path_prefix(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class AppIngressSpecRuleRoutingRedirectArgs:
    def __init__(__self__, *,
        ...
        """
        The redirect configuration for the rule. Only one of `component` or `redirect` may be set.
        :param pulumi.Input[_builtins.str] authority: The authority/host to redirect to. This can be a hostname or IP address. Note: use `port` to set the port.
        :param pulumi.Input[_builtins.int] port: The port to redirect to.
        :param pulumi.Input[_builtins.int] redirect_code: The redirect code to use. Defaults to `302`. Supported values are 300, 301, 302, 303, 304, 307, 308.
        :param pulumi.Input[_builtins.str] scheme: The scheme to redirect to. Supported values are `http` or `https`. Default: `https`.
        :param pulumi.Input[_builtins.str] uri: An optional URI path to redirect to. Note: if this is specified the whole URI of the original request will be overwritten to this value, irrespective of the original request URI being matched.
        """
...
class AppIngressSpecRuleStringMatchArgs:
    def __init__(__self__, *,
        ...
        """
        The path to match on.
        :param pulumi.Input[_builtins.str] prefix: Prefix-based match. For example, `/api` will match `/api`, `/api/`, and any nested paths such as `/api/v1/endpoint`.
        """
...
class AppJobSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dockerfile_path: The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.
        :param pulumi.Input[_builtins.str] environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param pulumi.Input[Sequence[pulumi.Input['AppVariableDefinitionArgs']]] envs: A list of environment variables made available to the component.
        :param pulumi.Input[_builtins.int] instance_count: The amount of instances that this component should be scaled to. Default: 1
...
class AppRouteSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] path: An HTTP path prefix. Paths must start with / and must be unique across all components within an app.
        :param pulumi.Input[_builtins.bool] preserve_path_prefix: An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
        if preserve_path_prefix is not None:
...
class AppServiceSpecHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] http_path: The route path used for the HTTP health check ping. If not set, the HTTP health check will be disabled and a TCP health check used instead.
        ...
        :param pulumi.Input[_builtins.int] port: The port on which the health check will be performed. If not set, the health check will be performed on the component's http_port.
...
class AppServiceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param pulumi.Input[Sequence[pulumi.Input['AppVariableDefinitionArgs']]] envs: A list of environment variables made available to the component.
        :param pulumi.Input[_builtins.int] http_port: The internal port on which this service's run command will listen. Default: 8080
               If there is not an environment variable with the name `PORT`, one will be automatically added with its value set to the value of this field.
        :param pulumi.Input[_builtins.int] instance_count: The amount of instances that this component should be scaled to. Default: 1
        :param pulumi.Input['AppComponentInstanceBaseInstanceSizeSlug'] instance_size_slug: The instance size to use for this component. Default: `basic-xxs`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] internal_ports: The ports on which this service will listen for internal traffic.
        :param pulumi.Input[_builtins.str] name: The name. Must be unique across all components within the same app.
        :param pulumi.Input[Sequence[pulumi.Input['AppRouteSpecArgs']]] routes: A list of HTTP routes that should be routed to this component.
        :param pulumi.Input[_builtins.str] run_command: An optional run command to override the component's default.
        :param pulumi.Input[_builtins.str] source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
...
class AppSpecArgs:
    def __init__(__self__, *,
        ...
        """
        The desired configuration of an application.
        :param pulumi.Input[_builtins.str] name: The name of the app. Must be unique across all apps in the same account.
...
class AppStaticSiteSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] build_command: An optional build command to run while building this component from source.
        :param pulumi.Input[_builtins.str] catchall_document: The name of the document to use as the fallback for any requests to documents that are not found when serving this static site. Only 1 of `catchall_document` or `error_document` can be set.
        :param pulumi.Input[_builtins.str] dockerfile_path: The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.
        :param pulumi.Input[_builtins.str] environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param pulumi.Input[Sequence[pulumi.Input['AppVariableDefinitionArgs']]] envs: A list of environment variables made available to the component.
        :param pulumi.Input[_builtins.str] error_document: The name of the error document to use when serving this static site. Default: 404.html. If no such file exists within the built assets, App Platform will supply one.
        :param pulumi.Input[_builtins.str] index_document: The name of the index document to use when serving this static site. Default: index.html
        :param pulumi.Input[_builtins.str] name: The name. Must be unique across all components within the same app.
        :param pulumi.Input[_builtins.str] output_dir: An optional path to where the built assets will be located, relative to the build context. If not set, App Platform will automatically scan for these directory names: `_static`, `dist`, `public`, `build`.
        :param pulumi.Input[Sequence[pulumi.Input['AppRouteSpecArgs']]] routes: A list of HTTP routes that should be routed to this component.
        :param pulumi.Input[_builtins.str] run_command: An optional run command to override the component's default.
        :param pulumi.Input[_builtins.str] source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
        """
...
class AppVariableDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: The variable name
        ...
        :param pulumi.Input['AppVariableDefinitionType'] type: - GENERAL: A plain-text environment variable
               - SECRET: A secret encrypted environment variable
        :param pulumi.Input[_builtins.str] value: The value. If the type is `SECRET`, the value will be encrypted on first submission. On following submissions, the encrypted value should be used.
        """
...
class AppsCorsPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] max_age: An optional duration specifying how long browsers can cache the results of a preflight request. This configures the `Access-Control-Max-Age` header.
        """
...
class AppsGitSourceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repo_clone_url: The clone URL of the repo. Example: `https://github.com/digitalocean/sample-golang.git`
        """
...
class AppsGithubSourceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repo: The name of the repo in the format owner/repo. Example: `digitalocean/sample-golang`
        """
        if branch is not None:
            pulumi.set(__self__, "branch", branch)
...
class AppsImageSourceSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] registry: The registry name. Must be left empty for the `DOCR` registry type.
...
class AppsStringMatchArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] exact: Exact string match. Only 1 of `exact`, `prefix`, or `regex` must be set.
        :param pulumi.Input[_builtins.str] prefix: Prefix-based match. Only 1 of `exact`, `prefix`, or `regex` must be set.
        :param pulumi.Input[_builtins.str] regex: RE2 style regex-based match. Only 1 of `exact`, `prefix`, or `regex` must be set. For more information about RE2 syntax, see: https://github.com/google/re2/wiki/Syntax
        """
