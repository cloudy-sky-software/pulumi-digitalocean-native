...
def get_apps_instance_size(slug: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableAppsGetInstanceSizeResponse:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str slug: The slug of the instance size
    """
    __args__ = dict()
    __args__['slug'] = slug
...
def get_apps_instance_size_output(slug: Optional[pulumi.Input[_builtins.str]] = None,
