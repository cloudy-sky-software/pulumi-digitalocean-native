...
class AppsGetLogsResponse:
    ...
    def historic_urls(self) -> Optional[Sequence[_builtins.str]]:
...
def get_apps_logs_active_deployment(app_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str component_name: An optional component name. If set, logs will be limited to this component only.
    """
    __args__ = dict()
    __args__['appId'] = app_id
    __args__['componentName'] = component_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('digitalocean-native:apps/v2:getAppsLogsActiveDeployment', __args__, opts=opts, typ=AppsGetLogsResponse).value

    return AwaitableAppsGetLogsResponse(
        historic_urls=pulumi.get(__ret__, 'historic_urls'),
        live_url=pulumi.get(__ret__, 'live_url'))
def get_apps_logs_active_deployment_output(app_id: Optional[pulumi.Input[_builtins.str]] = None,
