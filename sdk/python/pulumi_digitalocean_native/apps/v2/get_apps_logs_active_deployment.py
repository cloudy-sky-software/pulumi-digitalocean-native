...
def get_apps_logs_active_deployment(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str component_name: An optional component name. If set, logs will be limited to this component only.
    """
    __args__ = dict()
...
def get_apps_logs_active_deployment_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
