...
class App(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_ingress: Optional[builtins.str] = None,
                 domains: Optional[Sequence['outputs.AppsDomain']] = None,
                 id: Optional[builtins.str] = None,
                 in_progress_deployment: Optional['outputs.AppsDeployment'] = None,
                 last_deployment_created_at: Optional[builtins.str] = None,
                 live_domain: Optional[builtins.str] = None,
                 live_url: Optional[builtins.str] = None,
                 live_url_base: Optional[builtins.str] = None,
                 ...
                 tier_slug: Optional[builtins.str] = None,
    ...
    def default_ingress(self) -> Optional[builtins.str]:
    ...
    def last_deployment_created_at(self) -> Optional[builtins.str]:
        return pulumi.get(self, "last_deployment_created_at")

    @property
    @pulumi.getter(name="liveDomain")
    def live_domain(self) -> Optional[builtins.str]:
    ...
    def live_url_base(self) -> Optional[builtins.str]:
    ...
    def tier_slug(self) -> Optional[builtins.str]:
...
class AppAlertProgressStep(dict):
    ...
    def __init__(__self__, *,
                 ended_at: Optional[builtins.str] = None,
    ...
    def ended_at(self) -> Optional[builtins.str]:
...
class AppAlertSpec(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disabled: Is the alert disabled?
        :param builtins.float value: Threshold value for alert
        """
...
class AppDatabaseSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name. Must be unique across all components within the same app.
...
class AppDomainSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str domain: The hostname for the domain
        ...
        :param builtins.str zone: Optional. If the domain uses DigitalOcean DNS and you would like App
...
class AppFunctionsSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
        """
        pulumi.set(__self__, "name", name)
...
class AppIngressSpecRuleRoutingComponent(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 preserve_path_prefix: Optional[builtins.str] = None,
                 rewrite: Optional[builtins.str] = None):
        """
        The component to route to. Only one of `component` or `redirect` may be set.
        :param builtins.str name: The name of the component to route to.
        :param builtins.str preserve_path_prefix: An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`. Note: this is not applicable for Functions Components and is mutually exclusive with `rewrite`.
        :param builtins.str rewrite: An optional field that will rewrite the path of the component to be what is specified here. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If you specified the rewrite to be `/v1/`, requests to `/api/list` would be rewritten to `/v1/list`. Note: this is mutually exclusive with `preserve_path_prefix`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def preserve_path_prefix(self) -> Optional[builtins.str]:
        """
...
class AppIngressSpecRuleRoutingRedirect(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The redirect configuration for the rule. Only one of `component` or `redirect` may be set.
        :param builtins.str authority: The authority/host to redirect to. This can be a hostname or IP address. Note: use `port` to set the port.
        :param builtins.int port: The port to redirect to.
        :param builtins.int redirect_code: The redirect code to use. Defaults to `302`. Supported values are 300, 301, 302, 303, 304, 307, 308.
        :param builtins.str scheme: The scheme to redirect to. Supported values are `http` or `https`. Default: `https`.
        :param builtins.str uri: An optional URI path to redirect to. Note: if this is specified the whole URI of the original request will be overwritten to this value, irrespective of the original request URI being matched.
        """
...
class AppIngressSpecRuleStringMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The path to match on.
        :param builtins.str prefix: Prefix-based match. For example, `/api` will match `/api`, `/api/`, and any nested paths such as `/api/v1/endpoint`.
        """
...
class AppJobSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str dockerfile_path: The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.
        :param builtins.str environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param Sequence['AppVariableDefinition'] envs: A list of environment variables made available to the component.
        :param builtins.int instance_count: The amount of instances that this component should be scaled to. Default: 1
...
class AppMetricsBandwidthUsageDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bandwidth_bytes: Optional[builtins.str] = None):
        """
        Bandwidth usage for an app.
        :param builtins.str app_id: The ID of the app.
        :param builtins.str bandwidth_bytes: The used bandwidth amount in bytes.
        """
    ...
    def bandwidth_bytes(self) -> Optional[builtins.str]:
        """
...
class AppPendingDeployment(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cloned_from: Optional[builtins.str] = None,
                 created_at: Optional[builtins.str] = None,
                 ...
                 phase_last_updated_at: Optional[builtins.str] = None,
    ...
    def cloned_from(self) -> Optional[builtins.str]:
    ...
    def phase_last_updated_at(self) -> Optional[builtins.str]:
...
class AppRollbackValidationCondition(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A human-readable message describing the failing condition.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class AppRouteSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str path: An HTTP path prefix. Paths must start with / and must be unique across all components within an app.
        :param builtins.bool preserve_path_prefix: An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
        if preserve_path_prefix is not None:
...
class AppServiceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param Sequence['AppVariableDefinition'] envs: A list of environment variables made available to the component.
        :param builtins.int http_port: The internal port on which this service's run command will listen. Default: 8080
        ...
        :param builtins.int instance_count: The amount of instances that this component should be scaled to. Default: 1
        :param 'AppComponentInstanceBaseInstanceSizeSlug' instance_size_slug: The instance size to use for this component. Default: `basic-xxs`
        :param Sequence[builtins.int] internal_ports: The ports on which this service will listen for internal traffic.
        :param builtins.str name: The name. Must be unique across all components within the same app.
        :param Sequence['AppRouteSpec'] routes: A list of HTTP routes that should be routed to this component.
        :param builtins.str run_command: An optional run command to override the component's default.
        :param builtins.str source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
...
class AppServiceSpecHealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str http_path: The route path used for the HTTP health check ping. If not set, the HTTP health check will be disabled and a TCP health check used instead.
...
class AppSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The desired configuration of an application.
        :param builtins.str name: The name of the app. Must be unique across all apps in the same account.
...
class AppStaticSiteSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str build_command: An optional build command to run while building this component from source.
        :param builtins.str catchall_document: The name of the document to use as the fallback for any requests to documents that are not found when serving this static site. Only 1 of `catchall_document` or `error_document` can be set.
        :param builtins.str dockerfile_path: The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.
        :param builtins.str environment_slug: An environment slug describing the type of this app. For a full list, please refer to [the product documentation](https://www.digitalocean.com/docs/app-platform/).
        :param Sequence['AppVariableDefinition'] envs: A list of environment variables made available to the component.
        :param builtins.str error_document: The name of the error document to use when serving this static site. Default: 404.html. If no such file exists within the built assets, App Platform will supply one.
        :param builtins.str index_document: The name of the index document to use when serving this static site. Default: index.html
        :param builtins.str name: The name. Must be unique across all components within the same app.
        :param builtins.str output_dir: An optional path to where the built assets will be located, relative to the build context. If not set, App Platform will automatically scan for these directory names: `_static`, `dist`, `public`, `build`.
        :param Sequence['AppRouteSpec'] routes: A list of HTTP routes that should be routed to this component.
        :param builtins.str run_command: An optional run command to override the component's default.
        :param builtins.str source_dir: An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
        """
...
class AppVariableDefinition(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The variable name
        ...
        :param builtins.str value: The value. If the type is `SECRET`, the value will be encrypted on first submission. On following submissions, the encrypted value should be used.
        """
...
class AppsCorsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str max_age: An optional duration specifying how long browsers can cache the results of a preflight request. This configures the `Access-Control-Max-Age` header.
        """
...
class AppsDeploymentFunctions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_commit_hash: Optional[builtins.str] = None):
        """
        :param builtins.str namespace: The namespace where the functions are deployed.
        :param builtins.str source_commit_hash: The commit hash of the repository that was used to build this functions component.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def source_commit_hash(self) -> Optional[builtins.str]:
        """
...
class AppsDeploymentProgress(dict):
    ...
    def __init__(__self__, *,
                 error_steps: Optional[builtins.int] = None,
                 pending_steps: Optional[builtins.int] = None,
                 running_steps: Optional[builtins.int] = None,
                 steps: Optional[Sequence['outputs.AppsDeploymentProgressStep']] = None,
                 success_steps: Optional[builtins.int] = None,
                 summary_steps: Optional[Sequence['outputs.AppsDeploymentProgressStep']] = None,
                 total_steps: Optional[builtins.int] = None):
    ...
    def success_steps(self) -> Optional[builtins.int]:
    ...
    def total_steps(self) -> Optional[builtins.int]:
...
class AppsDeploymentProgressStep(dict):
    ...
    def __init__(__self__, *,
                 component_name: Optional[builtins.str] = None,
                 ended_at: Optional[builtins.str] = None,
                 message_base: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str message_base: The base of a human-readable description of the step intended to be combined with the component name for presentation. For example:
    ...
    def message_base(self) -> Optional[builtins.str]:
        """
...
class AppsDomain(dict):
    ...
    def __init__(__self__, *,
                 certificate_expires_at: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 phase: Optional['AppsDomainPhase'] = None,
                 progress: Optional['outputs.AppsDomainProgress'] = None,
                 rotate_validation_records: Optional[builtins.bool] = None,
    ...
    def certificate_expires_at(self) -> Optional[builtins.str]:
    ...
    def rotate_validation_records(self) -> Optional[builtins.bool]:
...
class AppsGitSourceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str repo_clone_url: The clone URL of the repo. Example: `https://github.com/digitalocean/sample-golang.git`
        """
...
class AppsGithubSourceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str repo: The name of the repo in the format owner/repo. Example: `digitalocean/sample-golang`
        """
        if branch is not None:
            pulumi.set(__self__, "branch", branch)
...
class AppsImageSourceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str registry: The registry name. Must be left empty for the `DOCR` registry type.
...
class AppsInstanceSize(dict):
    def __init__(__self__, *,
                 ...
                 cpus: Optional[builtins.str] = None,
                 memory_bytes: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 slug: Optional[builtins.str] = None,
                 tier_downgrade_to: Optional[builtins.str] = None,
                 tier_slug: Optional[builtins.str] = None,
                 tier_upgrade_to: Optional[builtins.str] = None,
                 usd_per_month: Optional[builtins.str] = None,
                 usd_per_second: Optional[builtins.str] = None):
        if cpu_type is None:
    ...
    @property
    @pulumi.getter
    def cpus(self) -> Optional[builtins.str]:
        return pulumi.get(self, "cpus")

    @property
    @pulumi.getter(name="memoryBytes")
    def memory_bytes(self) -> Optional[builtins.str]:
    ...
    def tier_downgrade_to(self) -> Optional[builtins.str]:
    ...
    def tier_upgrade_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "tier_upgrade_to")

    @property
    @pulumi.getter(name="usdPerMonth")
    def usd_per_month(self) -> Optional[builtins.str]:
        return pulumi.get(self, "usd_per_month")

    @property
    @pulumi.getter(name="usdPerSecond")
    def usd_per_second(self) -> Optional[builtins.str]:
...
class AppsRegion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_centers: Optional[Sequence[builtins.str]] = None,
                 default: Optional[builtins.bool] = None,
                 disabled: Optional[builtins.bool] = None,
                 flag: Optional[builtins.str] = None,
                 label: Optional[builtins.str] = None,
                 reason: Optional[builtins.str] = None,
                 slug: Optional[builtins.str] = None):
        """
        :param builtins.bool default: Whether or not the region is presented as the default.
        """
    ...
    def data_centers(self) -> Optional[Sequence[builtins.str]]:
...
class AppsStringMatch(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str exact: Exact string match. Only 1 of `exact`, `prefix`, or `regex` must be set.
        :param builtins.str prefix: Prefix-based match. Only 1 of `exact`, `prefix`, or `regex` must be set.
        :param builtins.str regex: RE2 style regex-based match. Only 1 of `exact`, `prefix`, or `regex` must be set. For more information about RE2 syntax, see: https://github.com/google/re2/wiki/Syntax
        """
...
class AppsTier(dict):
    def __init__(__self__, *,
                 build_seconds: Optional[builtins.str] = None,
                 egress_bandwidth_bytes: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 slug: Optional[builtins.str] = None,
                 storage_bytes: Optional[builtins.str] = None):
    ...
    def build_seconds(self) -> Optional[builtins.str]:
        return pulumi.get(self, "build_seconds")

    @property
    @pulumi.getter(name="egressBandwidthBytes")
    def egress_bandwidth_bytes(self) -> Optional[builtins.str]:
    ...
    def storage_bytes(self) -> Optional[builtins.str]:
