...
class AppsListMetricsBandwidthDailyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] app_ids: A list of app IDs to query bandwidth metrics for.
        :param pulumi.Input[_builtins.str] date: Optional day to query. Only the date component of the timestamp will be considered. Default: yesterday.
        """
...
@pulumi.type_token("digitalocean-native:apps/v2:AppsListMetricsBandwidthDaily")
class AppsListMetricsBandwidthDaily(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def date(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
