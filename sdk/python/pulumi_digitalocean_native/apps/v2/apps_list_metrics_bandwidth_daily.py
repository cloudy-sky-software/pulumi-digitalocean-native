...
class AppsListMetricsBandwidthDailyArgs:
    def __init__(__self__, *,
                 app_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] app_ids: A list of app IDs to query bandwidth metrics for.
        :param pulumi.Input[builtins.str] date: Optional day to query. Only the date component of the timestamp will be considered. Default: yesterday.
        """
    ...
    def app_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @app_ids.setter
    def app_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class AppsListMetricsBandwidthDaily(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appIds")
    def app_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of app IDs to query bandwidth metrics for.
        """
        return pulumi.get(self, "app_ids")
