...
def get_apps_logs_active_deployment_aggregate(app_id: Optional[builtins.str] = None,
...
def get_apps_logs_active_deployment_aggregate_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
