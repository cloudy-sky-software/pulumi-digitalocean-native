...
class AppsValidateAppSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] app_id: An optional ID of an existing app. If set, the spec will be treated as a proposed update to the specified app. The existing app is not modified using this method.
        """
...
@pulumi.type_token("digitalocean-native:apps/v2:AppsValidateAppSpec")
class AppsValidateAppSpec(pulumi.CustomResource):
    ...
    def app_cost(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
    ...
    def app_is_static(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
    ...
    def app_name_available(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
    ...
    def app_name_suggestion(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
    ...
    def app_tier_downgrade_cost(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
    ...
    def existing_static_apps(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
