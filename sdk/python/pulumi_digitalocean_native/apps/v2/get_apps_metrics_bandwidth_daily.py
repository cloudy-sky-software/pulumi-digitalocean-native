...
def get_apps_metrics_bandwidth_daily(app_id: Optional[builtins.str] = None,
...
def get_apps_metrics_bandwidth_daily_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
