...
class AppAlertPhase(builtins.str, Enum):
    UNKNOWN = "UNKNOWN"
    PENDING = "PENDING"
...
class AppAlertProgressStepStatus(builtins.str, Enum):
    UNKNOWN = "UNKNOWN"
    PENDING = "PENDING"
    RUNNING = "RUNNING"
    ERROR = "ERROR"
...
class AppAlertSpecOperator(builtins.str, Enum):
    UNSPECIFIED_OPERATOR = "UNSPECIFIED_OPERATOR"
    GREATER_THAN = "GREATER_THAN"
    LESS_THAN = "LESS_THAN"


class AppAlertSpecRule(builtins.str, Enum):
...
class AppAlertSpecWindow(builtins.str, Enum):
...
class AppComponentInstanceBaseInstanceSizeSlug(builtins.str, Enum):
    """
...
class AppDatabaseSpecEngine(builtins.str, Enum):
    """
    - MYSQL: MySQL
    - PG: PostgreSQL
    - REDIS: Redis
...
class AppDomainSpecMinimumTlsVersion(builtins.str, Enum):
    """
...
class AppDomainSpecType(builtins.str, Enum):
    """
...
class AppJobSpecPropertiesKind(builtins.str, Enum):
    """
...
class AppRollbackValidationConditionCode(builtins.str, Enum):
    """
...
class AppSpecRegion(builtins.str, Enum):
    """
...
class AppVariableDefinitionScope(builtins.str, Enum):
    """
...
class AppVariableDefinitionType(builtins.str, Enum):
    """
...
class AppsDeploymentPhase(builtins.str, Enum):
    UNKNOWN = "UNKNOWN"
...
class AppsDeploymentProgressStepStatus(builtins.str, Enum):
    UNKNOWN = "UNKNOWN"
    PENDING = "PENDING"
    RUNNING = "RUNNING"
    ERROR = "ERROR"
...
class AppsDomainPhase(builtins.str, Enum):
    UNKNOWN = "UNKNOWN"
    PENDING = "PENDING"
    CONFIGURING = "CONFIGURING"
    ACTIVE = "ACTIVE"
...
class AppsImageSourceSpecRegistryType(builtins.str, Enum):
    """
...
class AppsInstanceSizeCpuType(builtins.str, Enum):
    UNSPECIFIED = "UNSPECIFIED"
    SHARED = "SHARED"
    DEDICATED = "DEDICATED"
