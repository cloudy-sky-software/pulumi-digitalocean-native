...
def get_apps_tier(slug: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableAppsGetTierResponse:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str slug: The slug of the tier
    """
    __args__ = dict()
    __args__['slug'] = slug
...
def get_apps_tier_output(slug: Optional[pulumi.Input[_builtins.str]] = None,
