...
class BillingHistory(dict):
    def __init__(__self__, *,
                 amount: Optional[builtins.str] = None,
                 date: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 invoice_id: Optional[builtins.str] = None,
                 invoice_uuid: Optional[builtins.str] = None,
                 type: Optional['BillingHistoryType'] = None):
        """
        :param builtins.str amount: Amount of the billing history entry.
        :param builtins.str date: Time the billing history entry occurred.
        :param builtins.str description: Description of the billing history entry.
        :param builtins.str invoice_id: ID of the invoice associated with the billing history entry, if  applicable.
        :param builtins.str invoice_uuid: UUID of the invoice associated with the billing history entry, if  applicable.
    ...
    @property
    @pulumi.getter
    def amount(self) -> Optional[builtins.str]:
        """
    ...
    def invoice_uuid(self) -> Optional[builtins.str]:
        """
...
class InvoicePreview(dict):
    ...
    def __init__(__self__, *,
                 amount: Optional[builtins.str] = None,
                 invoice_period: Optional[builtins.str] = None,
                 invoice_uuid: Optional[builtins.str] = None,
                 updated_at: Optional[builtins.str] = None):
        """
        The invoice preview.
        :param builtins.str amount: Total amount of the invoice, in USD.  This will reflect month-to-date usage in the invoice preview.
        :param builtins.str invoice_period: Billing period of usage for which the invoice is issued, in `YYYY-MM`  format.
        :param builtins.str invoice_uuid: The UUID of the invoice. The canonical reference for the invoice.
        :param builtins.str updated_at: Time the invoice was last updated.  This is only included with the invoice preview.
        """
        if amount is not None:
            pulumi.set(__self__, "amount", amount)
    ...
    def invoice_period(self) -> Optional[builtins.str]:
        """
