...
def list_floating_ips_action(floating_ip: Optional[builtins.str] = None,
...
def list_floating_ips_action_output(floating_ip: Optional[pulumi.Input[builtins.str]] = None,
