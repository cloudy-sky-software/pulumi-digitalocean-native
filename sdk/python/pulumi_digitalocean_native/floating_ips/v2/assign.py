...
class AssignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] droplet_id: The ID of the Droplet that the floating IP will be assigned to.
        :param pulumi.Input['FloatingIPsActionType'] type: The type of action to initiate for the floating IP.
        :param pulumi.Input[_builtins.str] floating_ip: A floating IP address.
        """
...
@pulumi.type_token("digitalocean-native:floating_ips/v2:Assign")
