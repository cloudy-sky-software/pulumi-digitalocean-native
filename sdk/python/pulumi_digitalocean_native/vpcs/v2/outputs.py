...
class Vpc(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str created_at: A time value given in ISO8601 combined date and time format.
        :param _builtins.bool default: A boolean value indicating whether or not the VPC is the default network for the region. All applicable resources are placed into the default VPC network unless otherwise specified during their creation. The `default` field cannot be unset from `true`. If you want to set a new default VPC network, update the `default` field of another VPC network in the same region. The previous network's `default` field will be set to `false` when a new default VPC has been defined.
        :param _builtins.str description: A free-form text field for describing the VPC's purpose. It may be a maximum of 255 characters.
        :param _builtins.str id: A unique ID that can be used to identify and reference the VPC.
        :param _builtins.str ip_range: The range of IP addresses in the VPC in CIDR notation. Network ranges cannot overlap with other networks in the same account and must be in range of private addresses as defined in RFC1918. It may not be smaller than `/28` nor larger than `/16`. If no IP range is specified, a `/20` network range is generated that won't conflict with other VPC networks in your account.
        :param _builtins.str name: The name of the VPC. Must be unique and may only contain alphanumeric characters, dashes, and periods.
        :param _builtins.str region: The slug identifier for the region where the VPC will be created.
...
class VpcMember(dict):
    def __init__(__self__, *,
                 ...
                 urn: Optional[_builtins.str] = None):
        """
        :param _builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the resource was created.
