...
class VpcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A free-form text field for describing the VPC's purpose. It may be a maximum of 255 characters.
        :param pulumi.Input[builtins.str] ip_range: The range of IP addresses in the VPC in CIDR notation. Network ranges cannot overlap with other networks in the same account and must be in range of private addresses as defined in RFC1918. It may not be smaller than `/28` nor larger than `/16`. If no IP range is specified, a `/20` network range is generated that won't conflict with other VPC networks in your account.
        :param pulumi.Input[builtins.str] name: The name of the VPC. Must be unique and may only contain alphanumeric characters, dashes, and periods.
        :param pulumi.Input[builtins.str] region: The slug identifier for the region where the VPC will be created.
        """
