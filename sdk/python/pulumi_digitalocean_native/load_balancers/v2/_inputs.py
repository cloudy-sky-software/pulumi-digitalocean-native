...
class ForwardingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The ID of the TLS certificate used for SSL termination if enabled.
        :param pulumi.Input[builtins.bool] tls_passthrough: A boolean value indicating whether SSL encrypted traffic will be passed through to the backend Droplets.
        """
...
class HealthCheckArgs:
    def __init__(__self__, *,
        ...
        """
        An object specifying health check settings for the load balancer.
        :param pulumi.Input[builtins.int] check_interval_seconds: The number of seconds between between two consecutive health checks.
        :param pulumi.Input[builtins.int] healthy_threshold: The number of times a health check must pass for a backend Droplet to be marked "healthy" and be re-added to the pool.
        ...
        :param pulumi.Input[builtins.int] response_timeout_seconds: The number of seconds the load balancer instance will wait for a response until marking a health check as failed.
        :param pulumi.Input[builtins.int] unhealthy_threshold: The number of times a health check must fail for a backend Droplet to be marked "unhealthy" and be removed from the pool.
        """
...
if not MYPY:
    class LbFirewallArgsDict(TypedDict):
        ...
        """
        deny: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class LbFirewallArgs:
    def __init__(__self__, *,
                 ...
                 deny: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        An object specifying allow and deny rules to control traffic to the load balancer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow: the rules for allowing traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] deny: the rules for denying traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        """
    ...
    @property
    @pulumi.getter
    def deny(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        the rules for denying traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        """
    ...
    @deny.setter
    def deny(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class StickySessionsArgs:
    def __init__(__self__, *,
        ...
        """
        An object specifying sticky sessions settings for the load balancer.
        :param pulumi.Input[builtins.str] cookie_name: The name of the cookie sent to the client. This attribute is only returned when using `cookies` for the sticky sessions type.
        :param pulumi.Input[builtins.int] cookie_ttl_seconds: The number of seconds until the cookie set by the load balancer expires. This attribute is only returned when using `cookies` for the sticky sessions type.
