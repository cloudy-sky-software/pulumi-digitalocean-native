...
class ForwardingRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool tls_passthrough: A boolean value indicating whether SSL encrypted traffic will be passed through to the backend Droplets.
        """
...
class HealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int response_timeout_seconds: The number of seconds the load balancer instance will wait for a response until marking a health check as failed.
...
class LbFirewall(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object specifying allow and deny rules to control traffic to the load balancer.
        :param Sequence[_builtins.str] allow: the rules for allowing traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        :param Sequence[_builtins.str] deny: the rules for denying traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        """
...
class LoadBalancer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_lets_encrypt_dns_records: Optional[_builtins.bool] = None,
                 enable_backend_keepalive: Optional[_builtins.bool] = None,
                 ...
                 http_idle_timeout_seconds: Optional[_builtins.int] = None,
                 ...
                 size_unit: Optional[_builtins.int] = None,
        ...
        :param _builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the load balancer was created.
        :param _builtins.bool disable_lets_encrypt_dns_records: A boolean value indicating whether to disable automatic DNS record creation for Let's Encrypt certificates that are added to the load balancer.
        :param _builtins.bool enable_backend_keepalive: A boolean value indicating whether HTTP keepalive connections are maintained to target Droplets.
        :param _builtins.bool enable_proxy_protocol: A boolean value indicating whether PROXY Protocol is in use.
        ...
        :param _builtins.int http_idle_timeout_seconds: An integer value which configures the idle timeout for HTTP requests to the target droplets.
        :param _builtins.str id: A unique ID that can be used to identify and reference a load balancer.
        :param _builtins.str ip: An attribute containing the public-facing IP address of the load balancer.
        :param _builtins.str name: A human-readable name for a load balancer instance.
        :param _builtins.str project_id: The ID of the project that the load balancer is associated with. If no ID is provided at creation, the load balancer associates with the user's default project. If an invalid project ID is provided, the load balancer will not be created.
        :param _builtins.bool redirect_http_to_https: A boolean value indicating whether HTTP requests to the load balancer on port 80 will be redirected to HTTPS on port 443.
        ...
        :param _builtins.int size_unit: How many nodes the load balancer contains. Each additional node increases the load balancer's ability to manage more connections. Load balancers can be scaled up or down, and you can change the number of nodes after creation up to once per hour. This field is currently not available in the AMS2, NYC2, or SFO1 regions. Use the `size` field to scale load balancers that reside in these regions.
        ...
        :param _builtins.str tag: The name of a Droplet tag corresponding to Droplets assigned to the load balancer.
        :param _builtins.str vpc_uuid: A string specifying the UUID of the VPC to which the load balancer is assigned.
        """
    ...
    def disable_lets_encrypt_dns_records(self) -> Optional[_builtins.bool]:
        """
    ...
    def enable_backend_keepalive(self) -> Optional[_builtins.bool]:
        """
    ...
    def http_idle_timeout_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def size_unit(self) -> Optional[_builtins.int]:
        """
...
class StickySessions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object specifying sticky sessions settings for the load balancer.
        :param _builtins.str cookie_name: The name of the cookie sent to the client. This attribute is only returned when using `cookies` for the sticky sessions type.
        :param _builtins.int cookie_ttl_seconds: The number of seconds until the cookie set by the load balancer expires. This attribute is only returned when using `cookies` for the sticky sessions type.
