...
class ForwardingRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool tls_passthrough: A boolean value indicating whether SSL encrypted traffic will be passed through to the backend Droplets.
        """
...
class HealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int response_timeout_seconds: The number of seconds the load balancer instance will wait for a response until marking a health check as failed.
...
class LbFirewall(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object specifying allow and deny rules to control traffic to the load balancer.
        :param Sequence[builtins.str] allow: the rules for allowing traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        :param Sequence[builtins.str] deny: the rules for denying traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')
        """
...
class LoadBalancer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_lets_encrypt_dns_records: Optional[builtins.bool] = None,
                 enable_backend_keepalive: Optional[builtins.bool] = None,
                 ...
                 http_idle_timeout_seconds: Optional[builtins.int] = None,
                 id: Optional[builtins.str] = None,
                 ip: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 project_id: Optional[builtins.str] = None,
                 redirect_http_to_https: Optional[builtins.bool] = None,
                 size: Optional['LoadBalancerBaseSize'] = None,
                 size_unit: Optional[builtins.int] = None,
        ...
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the load balancer was created.
        :param builtins.bool disable_lets_encrypt_dns_records: A boolean value indicating whether to disable automatic DNS record creation for Let's Encrypt certificates that are added to the load balancer.
        :param builtins.bool enable_backend_keepalive: A boolean value indicating whether HTTP keepalive connections are maintained to target Droplets.
        :param builtins.bool enable_proxy_protocol: A boolean value indicating whether PROXY Protocol is in use.
        ...
        :param builtins.int http_idle_timeout_seconds: An integer value which configures the idle timeout for HTTP requests to the target droplets.
        :param builtins.str id: A unique ID that can be used to identify and reference a load balancer.
        :param builtins.str ip: An attribute containing the public-facing IP address of the load balancer.
        :param builtins.str name: A human-readable name for a load balancer instance.
        :param builtins.str project_id: The ID of the project that the load balancer is associated with. If no ID is provided at creation, the load balancer associates with the user's default project. If an invalid project ID is provided, the load balancer will not be created.
        :param builtins.bool redirect_http_to_https: A boolean value indicating whether HTTP requests to the load balancer on port 80 will be redirected to HTTPS on port 443.
        ...
        :param builtins.int size_unit: How many nodes the load balancer contains. Each additional node increases the load balancer's ability to manage more connections. Load balancers can be scaled up or down, and you can change the number of nodes after creation up to once per hour. This field is currently not available in the AMS2, NYC2, or SFO1 regions. Use the `size` field to scale load balancers that reside in these regions.
        ...
        :param builtins.str tag: The name of a Droplet tag corresponding to Droplets assigned to the load balancer.
        :param builtins.str vpc_uuid: A string specifying the UUID of the VPC to which the load balancer is assigned.
        """
    ...
    def disable_lets_encrypt_dns_records(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_backend_keepalive(self) -> Optional[builtins.bool]:
        """
    ...
    def http_idle_timeout_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def redirect_http_to_https(self) -> Optional[builtins.bool]:
        """
    ...
    def size_unit(self) -> Optional[builtins.int]:
        """
...
class StickySessions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object specifying sticky sessions settings for the load balancer.
        :param builtins.str cookie_name: The name of the cookie sent to the client. This attribute is only returned when using `cookies` for the sticky sessions type.
        :param builtins.int cookie_ttl_seconds: The number of seconds until the cookie set by the load balancer expires. This attribute is only returned when using `cookies` for the sticky sessions type.
