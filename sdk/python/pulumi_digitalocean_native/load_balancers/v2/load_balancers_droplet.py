...
class LoadBalancersDropletArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] droplet_ids: An array containing the IDs of the Droplets assigned to the load balancer.
        :param pulumi.Input[_builtins.str] lb_id: A unique identifier for a load balancer.
        """
...
@pulumi.type_token("digitalocean-native:load_balancers/v2:LoadBalancersDroplet")
