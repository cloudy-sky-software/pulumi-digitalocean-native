...
class LoadBalancersDropletArgs:
    def __init__(__self__, *,
                 droplet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.int]]],
                 lb_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LoadBalancersDroplet resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] droplet_ids: An array containing the IDs of the Droplets assigned to the load balancer.
        :param pulumi.Input[builtins.str] lb_id: A unique identifier for a load balancer.
        """
    ...
    def droplet_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
    ...
    @droplet_ids.setter
    def droplet_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
