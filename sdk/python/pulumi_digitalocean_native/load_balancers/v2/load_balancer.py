...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the load balancer was created.
        :param pulumi.Input[builtins.bool] disable_lets_encrypt_dns_records: A boolean value indicating whether to disable automatic DNS record creation for Let's Encrypt certificates that are added to the load balancer.
        :param pulumi.Input[builtins.bool] enable_backend_keepalive: A boolean value indicating whether HTTP keepalive connections are maintained to target Droplets.
        :param pulumi.Input[builtins.bool] enable_proxy_protocol: A boolean value indicating whether PROXY Protocol is in use.
        ...
        :param pulumi.Input[builtins.int] http_idle_timeout_seconds: An integer value which configures the idle timeout for HTTP requests to the target droplets.
        :param pulumi.Input[builtins.str] ip: An attribute containing the public-facing IP address of the load balancer.
        :param pulumi.Input[builtins.str] name: A human-readable name for a load balancer instance.
        :param pulumi.Input[builtins.str] project_id: The ID of the project that the load balancer is associated with. If no ID is provided at creation, the load balancer associates with the user's default project. If an invalid project ID is provided, the load balancer will not be created.
        :param pulumi.Input[builtins.bool] redirect_http_to_https: A boolean value indicating whether HTTP requests to the load balancer on port 80 will be redirected to HTTPS on port 443.
        ...
        :param pulumi.Input[builtins.int] size_unit: How many nodes the load balancer contains. Each additional node increases the load balancer's ability to manage more connections. Load balancers can be scaled up or down, and you can change the number of nodes after creation up to once per hour. This field is currently not available in the AMS2, NYC2, or SFO1 regions. Use the `size` field to scale load balancers that reside in these regions.
        ...
        :param pulumi.Input[builtins.str] vpc_uuid: A string specifying the UUID of the VPC to which the load balancer is assigned.
        """
...
class LoadBalancer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="httpIdleTimeoutSeconds")
    def http_idle_timeout_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        An integer value which configures the idle timeout for HTTP requests to the target droplets.
        """
        return pulumi.get(self, "http_idle_timeout_seconds")
    ...
    @property
    @pulumi.getter(name="sizeUnit")
    def size_unit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        How many nodes the load balancer contains. Each additional node increases the load balancer's ability to manage more connections. Load balancers can be scaled up or down, and you can change the number of nodes after creation up to once per hour. This field is currently not available in the AMS2, NYC2, or SFO1 regions. Use the `size` field to scale load balancers that reside in these regions.
        """
        return pulumi.get(self, "size_unit")
