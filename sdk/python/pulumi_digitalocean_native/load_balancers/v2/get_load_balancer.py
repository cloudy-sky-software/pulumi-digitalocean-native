...
def get_load_balancer(lb_id: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerProperties:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str lb_id: A unique identifier for a load balancer.
    """
    __args__ = dict()
    __args__['lbId'] = lb_id
...
def get_load_balancer_output(lb_id: Optional[pulumi.Input[builtins.str]] = None,
