...
class CdnEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] origin: The fully qualified domain name (FQDN) for the origin server which provides the content for the CDN. This is currently restricted to a Space.
        :param pulumi.Input[builtins.str] certificate_id: The ID of a DigitalOcean managed TLS certificate used for SSL when a custom subdomain is provided.
