...
class CdnEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str origin: The fully qualified domain name (FQDN) for the origin server which provides the content for the CDN. This is currently restricted to a Space.
        :param builtins.str certificate_id: The ID of a DigitalOcean managed TLS certificate used for SSL when a custom subdomain is provided.
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the CDN endpoint was created.
        :param builtins.str custom_domain: The fully qualified domain name (FQDN) of the custom subdomain used with the CDN endpoint.
        :param builtins.str endpoint: The fully qualified domain name (FQDN) from which the CDN-backed content is served.
        :param builtins.str id: A unique ID that can be used to identify and reference a CDN endpoint.
