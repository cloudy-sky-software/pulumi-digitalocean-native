...
def get_cdn_endpoint(cdn_id: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCdnEndpointProperties:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str cdn_id: A unique identifier for a CDN endpoint.
    """
    __args__ = dict()
...
def get_cdn_endpoint_output(cdn_id: Optional[pulumi.Input[builtins.str]] = None,
