...
def get_image_action(action_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str image_id: A unique number that can be used to identify and reference a specific image.
    """
    __args__ = dict()
...
def get_image_action_output(action_id: Optional[pulumi.Input[_builtins.str]] = None,
