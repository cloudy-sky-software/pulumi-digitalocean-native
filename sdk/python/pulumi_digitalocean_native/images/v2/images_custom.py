...
class ImagesCustomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional free-form text field to describe an image.
        ...
        :param pulumi.Input[builtins.str] name: The display name that has been given to an image.  This is what is shown in the control panel and is generally a descriptive title for the image in question.
        ...
        :param pulumi.Input[builtins.str] url: A URL from which the custom Linux virtual machine image may be retrieved.  The image it points to must be in the raw, qcow2, vhdx, vdi, or vmdk format.  It may be compressed using gzip or bzip2 and must be smaller than 100 GB after being decompressed.
        """
