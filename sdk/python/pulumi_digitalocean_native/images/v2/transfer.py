...
class TransferArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] image_id: A unique number that can be used to identify and reference a specific image.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def region(self) -> pulumi.Input['TransferPropertiesRegion']:
        """
    ...
    @region.setter
    def region(self, value: pulumi.Input['TransferPropertiesRegion']):
...
@pulumi.type_token("digitalocean-native:images/v2:Transfer")
class Transfer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Transfer, __self__).__init__(
            'digitalocean-native:images/v2:Transfer',
            resource_name,
            __props__,
            opts)
    ...
    def completed_at(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
    ...
    def resource_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
