...
def list_registry_repositories(registry_name: Optional[_builtins.str] = None,
...
def list_registry_repositories_output(registry_name: Optional[pulumi.Input[_builtins.str]] = None,
