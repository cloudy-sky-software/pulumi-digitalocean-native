...
class DockerCredentialsAuthsPropertiesRegistryDigitaloceanComProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str auth: A base64 encoded string containing credentials for the container registry.
        """
        if auth is not None:
...
class GarbageCollection(dict):
    def __init__(__self__, *,
                 blobs_deleted: Optional[builtins.int] = None,
                 created_at: Optional[builtins.str] = None,
                 freed_bytes: Optional[builtins.int] = None,
        ...
        """
        :param builtins.int blobs_deleted: The number of blobs deleted as a result of this garbage collection.
        :param builtins.str created_at: The time the garbage collection was created.
        :param builtins.int freed_bytes: The number of bytes freed as a result of this garbage collection.
        ...
        :param builtins.str updated_at: The time the garbage collection was last updated.
        :param builtins.str uuid: A string specifying the UUID of the garbage collection.
        """
    ...
    def blobs_deleted(self) -> Optional[builtins.int]:
        """
    ...
    def freed_bytes(self) -> Optional[builtins.int]:
        """
...
class GetRegistryOptionPropertiesOptionsProperties(dict):
    def __init__(__self__, *,
                 available_regions: Optional[Sequence[builtins.str]] = None,
    ...
    def available_regions(self) -> Optional[Sequence[builtins.str]]:
...
class GetRegistryOptionPropertiesOptionsPropertiesSubscriptionTiersItem(dict):
    def __init__(__self__, *,
                 allow_storage_overage: Optional[builtins.bool] = None,
                 eligibility_reasons: Optional[Sequence['SubscriptionTierExtendedEligibilityReasonsItem']] = None,
                 eligible: Optional[builtins.bool] = None,
                 included_bandwidth_bytes: Optional[builtins.int] = None,
                 included_repositories: Optional[builtins.int] = None,
                 included_storage_bytes: Optional[builtins.int] = None,
                 monthly_price_in_cents: Optional[builtins.int] = None,
                 name: Optional[builtins.str] = None,
                 slug: Optional[builtins.str] = None,
                 storage_overage_price_in_cents: Optional[builtins.int] = None):
        """
        :param builtins.bool allow_storage_overage: A boolean indicating whether the subscription tier supports additional storage above what is included in the base plan at an additional cost per GiB used.
        ...
        :param builtins.bool eligible: A boolean indicating whether your account it eligible to use a certain subscription tier.
        :param builtins.int included_bandwidth_bytes: The amount of outbound data transfer included in the subscription tier in bytes.
        :param builtins.int included_repositories: The number of repositories included in the subscription tier. `0` indicates that the subscription tier includes unlimited repositories.
        :param builtins.int included_storage_bytes: The amount of storage included in the subscription tier in bytes.
        :param builtins.int monthly_price_in_cents: The monthly cost of the subscription tier in cents.
        :param builtins.str name: The name of the subscription tier.
        :param builtins.str slug: The slug identifier of the subscription tier.
        :param builtins.int storage_overage_price_in_cents: The price paid in cents per GiB for additional storage beyond what is included in the subscription plan.
        """
    ...
    def allow_storage_overage(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def eligible(self) -> Optional[builtins.bool]:
        """
    ...
    def included_bandwidth_bytes(self) -> Optional[builtins.int]:
        """
    ...
    def included_repositories(self) -> Optional[builtins.int]:
        """
    ...
    def included_storage_bytes(self) -> Optional[builtins.int]:
        """
    ...
    def monthly_price_in_cents(self) -> Optional[builtins.int]:
        """
    ...
    def storage_overage_price_in_cents(self) -> Optional[builtins.int]:
        """
...
class Registry(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_usage_bytes: Optional[builtins.int] = None,
                 storage_usage_bytes_updated_at: Optional[builtins.str] = None,
                 subscription: Optional['outputs.RegistrySubscription'] = None):
        """
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the registry was created.
        :param builtins.str name: A globally unique name for the container registry. Must be lowercase and be composed only of numbers, letters and `-`, up to a limit of 63 characters.
        :param builtins.str region: Slug of the region where registry data is stored
        :param builtins.int storage_usage_bytes: The amount of storage used in the registry in bytes.
        :param builtins.str storage_usage_bytes_updated_at: The time at which the storage usage was updated. Storage usage is calculated asynchronously, and may not immediately reflect pushes to the registry.
        """
        if created_at is not None:
            pulumi.set(__self__, "created_at", created_at)
        if name is not None:
    ...
    def storage_usage_bytes(self) -> Optional[builtins.int]:
        """
    ...
    def storage_usage_bytes_updated_at(self) -> Optional[builtins.str]:
        """
...
class RegistrySubscription(dict):
    ...
    def __init__(__self__, *,
                 ...
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str created_at: The time at which the subscription was created.
        :param builtins.str updated_at: The time at which the subscription was last updated.
        """
        if created_at is not None:
            pulumi.set(__self__, "created_at", created_at)
        if tier is not None:
...
class Repository(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 registry_name: Optional[builtins.str] = None,
                 tag_count: Optional[builtins.int] = None):
        """
        :param builtins.str name: The name of the repository.
        :param builtins.str registry_name: The name of the container registry.
        :param builtins.int tag_count: The number of tags in the repository.
        """
    ...
    def tag_count(self) -> Optional[builtins.int]:
        """
...
class RepositoryBlob(dict):
    def __init__(__self__, *,
                 compressed_size_bytes: Optional[builtins.int] = None,
                 digest: Optional[builtins.str] = None):
        """
        :param builtins.int compressed_size_bytes: The compressed size of the blob in bytes.
        :param builtins.str digest: The digest of the blob
        """
    ...
    def compressed_size_bytes(self) -> Optional[builtins.int]:
        """
...
class RepositoryManifest(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int compressed_size_bytes: The compressed size of the manifest in bytes.
        :param builtins.str digest: The manifest digest
        :param builtins.str registry_name: The name of the container registry.
        :param builtins.str repository: The name of the repository.
        :param builtins.int size_bytes: The uncompressed size of the manifest in bytes (this size is calculated asynchronously so it may not be immediately available).
        :param Sequence[builtins.str] tags: All tags associated with this manifest
        :param builtins.str updated_at: The time the manifest was last updated.
        """
...
class RepositoryTag(dict):
    def __init__(__self__, *,
                 compressed_size_bytes: Optional[builtins.int] = None,
                 manifest_digest: Optional[builtins.str] = None,
                 registry_name: Optional[builtins.str] = None,
                 repository: Optional[builtins.str] = None,
                 size_bytes: Optional[builtins.int] = None,
                 ...
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.int compressed_size_bytes: The compressed size of the tag in bytes.
        :param builtins.str manifest_digest: The digest of the manifest associated with the tag.
        :param builtins.str registry_name: The name of the container registry.
        :param builtins.str repository: The name of the repository.
        :param builtins.int size_bytes: The uncompressed size of the tag in bytes (this size is calculated asynchronously so it may not be immediately available).
        :param builtins.str tag: The name of the tag.
        :param builtins.str updated_at: The time the tag was last updated.
        """
        if compressed_size_bytes is not None:
            pulumi.set(__self__, "compressed_size_bytes", compressed_size_bytes)
    ...
    def manifest_digest(self) -> Optional[builtins.str]:
        """
...
class RepositoryV2(dict):
    def __init__(__self__, *,
                 ...
                 manifest_count: Optional[builtins.int] = None,
                 name: Optional[builtins.str] = None,
                 registry_name: Optional[builtins.str] = None,
                 tag_count: Optional[builtins.int] = None):
        """
        :param builtins.int manifest_count: The number of manifests in the repository.
        :param builtins.str name: The name of the repository.
        :param builtins.str registry_name: The name of the container registry.
        :param builtins.int tag_count: The number of tags in the repository.
        """
    ...
    def manifest_count(self) -> Optional[builtins.int]:
        """
