...
@pulumi.type_token("digitalocean-native:registry/v2:GarbageCollectionStatus")
class GarbageCollectionStatus(_builtins.str, Enum):
    """
...
@pulumi.type_token("digitalocean-native:registry/v2:Region")
...
@pulumi.type_token("digitalocean-native:registry/v2:SubscriptionTierExtendedEligibilityReasonsItem")
class SubscriptionTierExtendedEligibilityReasonsItem(_builtins.str, Enum):
    OVER_REPOSITORY_LIMIT = "OverRepositoryLimit"
    OVER_STORAGE_LIMIT = "OverStorageLimit"


@pulumi.type_token("digitalocean-native:registry/v2:SubscriptionTierSlug")
class SubscriptionTierSlug(_builtins.str, Enum):
    """
...
@pulumi.type_token("digitalocean-native:registry/v2:TierSlug")
class TierSlug(_builtins.str, Enum):
    """
