...
def list_registry_garbage_collections(registry_name: Optional[_builtins.str] = None,
...
def list_registry_garbage_collections_output(registry_name: Optional[pulumi.Input[_builtins.str]] = None,
