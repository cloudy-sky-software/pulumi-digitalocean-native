...
def list_registry_garbage_collections(registry_name: Optional[builtins.str] = None,
...
def list_registry_garbage_collections_output(registry_name: Optional[pulumi.Input[builtins.str]] = None,
