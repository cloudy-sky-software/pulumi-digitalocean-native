...
def list_registry_repository_tags(registry_name: Optional[_builtins.str] = None,
...
def list_registry_repository_tags_output(registry_name: Optional[pulumi.Input[_builtins.str]] = None,
