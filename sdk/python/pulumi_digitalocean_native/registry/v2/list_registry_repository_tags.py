...
def list_registry_repository_tags(registry_name: Optional[builtins.str] = None,
...
def list_registry_repository_tags_output(registry_name: Optional[pulumi.Input[builtins.str]] = None,
