...
def list_registry_repository_manifests(registry_name: Optional[builtins.str] = None,
    ...
    :param builtins.str repository_name: The name of a container registry repository. If the name contains `/` characters, they must be URL-encoded, e.g. `%2F`.
    """
    __args__ = dict()
...
def list_registry_repository_manifests_output(registry_name: Optional[pulumi.Input[builtins.str]] = None,
