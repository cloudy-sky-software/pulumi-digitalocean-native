...
def list_registry_repositories_v2(registry_name: Optional[_builtins.str] = None,
...
def list_registry_repositories_v2_output(registry_name: Optional[pulumi.Input[_builtins.str]] = None,
