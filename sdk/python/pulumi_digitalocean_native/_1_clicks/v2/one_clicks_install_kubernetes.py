...
class OneClicksInstallKubernetesArgs:
    def __init__(__self__, *,
                 addon_slugs: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 cluster_uuid: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a OneClicksInstallKubernetes resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] addon_slugs: An array of 1-Click Application slugs to be installed to the Kubernetes cluster.
        :param pulumi.Input[_builtins.str] cluster_uuid: A unique ID for the Kubernetes cluster to which the 1-Click Applications will be installed.
        """
    ...
    def addon_slugs(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @addon_slugs.setter
    def addon_slugs(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
@pulumi.type_token("digitalocean-native:1-clicks/v2:OneClicksInstallKubernetes")
class OneClicksInstallKubernetes(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 addon_slugs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="addonSlugs")
    def addon_slugs(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        An array of 1-Click Application slugs to be installed to the Kubernetes cluster.
        """
        return pulumi.get(self, "addon_slugs")
