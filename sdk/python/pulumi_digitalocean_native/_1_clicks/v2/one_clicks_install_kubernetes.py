...
class OneClicksInstallKubernetesArgs:
    def __init__(__self__, *,
                 addon_slugs: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 cluster_uuid: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a OneClicksInstallKubernetes resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addon_slugs: An array of 1-Click Application slugs to be installed to the Kubernetes cluster.
        :param pulumi.Input[builtins.str] cluster_uuid: A unique ID for the Kubernetes cluster to which the 1-Click Applications will be installed.
        """
    ...
    def addon_slugs(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @addon_slugs.setter
    def addon_slugs(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class OneClicksInstallKubernetes(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 addon_slugs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="addonSlugs")
    def addon_slugs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of 1-Click Application slugs to be installed to the Kubernetes cluster.
        """
        return pulumi.get(self, "addon_slugs")
