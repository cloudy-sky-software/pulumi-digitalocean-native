...
class Alert(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str id: A unique ID that can be used to identify and reference the alert.
        :param builtins.str name: A human-friendly display name.
        ...
        :param builtins.int threshold: The threshold at which the alert will enter a trigger state. The specific threshold is dependent on the alert type.
...
class Check(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: A boolean value indicating whether the check is enabled/disabled.
        :param builtins.str id: A unique ID that can be used to identify and reference the check.
        :param builtins.str name: A human-friendly display name.
        :param Sequence['CheckUpdatableRegionsItem'] regions: An array containing the selected regions to perform healthchecks from.
        :param builtins.str target: The endpoint to perform healthchecks on.
...
class RegionState(dict):
    def __init__(__self__, *,
                 ...
                 status_changed_at: Optional[builtins.str] = None,
                 thirty_day_uptime_percentage: Optional[builtins.float] = None):
    ...
    def status_changed_at(self) -> Optional[builtins.str]:
        return pulumi.get(self, "status_changed_at")

    @property
    @pulumi.getter(name="thirtyDayUptimePercentage")
    def thirty_day_uptime_percentage(self) -> Optional[builtins.float]:
