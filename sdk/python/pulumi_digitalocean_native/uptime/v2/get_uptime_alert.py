...
def get_uptime_alert(alert_id: Optional[_builtins.str] = None,
                     check_id: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUptimeAlertProperties:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str alert_id: A unique identifier for an alert.
...
def get_uptime_alert_output(alert_id: Optional[pulumi.Input[_builtins.str]] = None,
