...
def list_reserved_ips_actions(reserved_ip: Optional[builtins.str] = None,
...
def list_reserved_ips_actions_output(reserved_ip: Optional[pulumi.Input[builtins.str]] = None,
