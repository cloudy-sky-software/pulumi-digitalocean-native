...
def list_reserved_ips_actions(reserved_ip: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListReservedIPsActionsItems:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str reserved_ip: A reserved IP address.
    """
    __args__ = dict()
...
def list_reserved_ips_actions_output(reserved_ip: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListReservedIPsActionsItems]:
    """
    Use this data source to access information about an existing resource.
