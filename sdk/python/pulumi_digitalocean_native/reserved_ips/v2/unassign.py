...
class UnassignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] droplet_id: The ID of the Droplet that the reserved IP will be unassigned from.
...
@pulumi.type_token("digitalocean-native:reserved_ips/v2:Unassign")
