...
class ReservedIPArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: The UUID of the project to which the reserved IP will be assigned.
        :param pulumi.Input[_builtins.str] region: The slug identifier for the region the reserved IP will be reserved to.
        """
...
@pulumi.type_token("digitalocean-native:reserved_ips/v2:ReservedIP")
