...
class ReservedIPArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The UUID of the project to which the reserved IP will be assigned.
        :param pulumi.Input[builtins.str] region: The slug identifier for the region the reserved IP will be reserved to.
        """
