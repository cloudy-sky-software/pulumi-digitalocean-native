...
def get_reserved_ips_action(action_id: Optional[builtins.str] = None,
                            reserved_ip: Optional[builtins.str] = None,
...
def get_reserved_ips_action_output(action_id: Optional[pulumi.Input[builtins.str]] = None,
