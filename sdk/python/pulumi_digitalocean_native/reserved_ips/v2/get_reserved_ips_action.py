...
def get_reserved_ips_action(action_id: Optional[_builtins.str] = None,
...
def get_reserved_ips_action_output(action_id: Optional[pulumi.Input[_builtins.str]] = None,
