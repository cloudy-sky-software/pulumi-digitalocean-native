...
class ReservedIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip: The public IP address of the reserved IP. It also serves as its identifier.
        :param _builtins.bool locked: A boolean value indicating whether or not the reserved IP has pending actions preventing new ones from being submitted.
        :param _builtins.str project_id: The UUID of the project to which the reserved IP currently belongs.
        """
