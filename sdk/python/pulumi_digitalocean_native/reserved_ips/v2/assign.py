...
class AssignArgs:
    def __init__(__self__, *,
                 ...
                 reserved_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Assign resource.
        :param pulumi.Input[builtins.int] droplet_id: The ID of the Droplet that the reserved IP will be assigned to.
        :param pulumi.Input['ReservedIpActionTypeType'] type: The type of action to initiate for the reserved IP.
        :param pulumi.Input[builtins.str] reserved_ip: A reserved IP address.
        """
    ...
    def reserved_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @reserved_ip.setter
    def reserved_ip(self, value: Optional[pulumi.Input[builtins.str]]):
