...
class AssignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] droplet_id: The ID of the Droplet that the reserved IP will be assigned to.
        :param pulumi.Input['ReservedIpActionTypeType'] type: The type of action to initiate for the reserved IP.
        :param pulumi.Input[_builtins.str] reserved_ip: A reserved IP address.
        """
...
@pulumi.type_token("digitalocean-native:reserved_ips/v2:Assign")
