...
def get_kubernetes_cluster_user(cluster_id: Optional[builtins.str] = None,
...
def get_kubernetes_cluster_user_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
