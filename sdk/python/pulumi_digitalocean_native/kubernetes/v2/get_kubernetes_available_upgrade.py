...
def get_kubernetes_available_upgrade(cluster_id: Optional[builtins.str] = None,
...
def get_kubernetes_available_upgrade_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
