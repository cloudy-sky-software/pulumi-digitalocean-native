...
def get_kubernetes_cluster_lint_result(cluster_id: Optional[builtins.str] = None,
...
def get_kubernetes_cluster_lint_result_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
