...
class KubernetesRecycleNodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] node_pool_id: A unique ID that can be used to reference a Kubernetes node pool.
        """
...
@pulumi.type_token("digitalocean-native:kubernetes/v2:KubernetesRecycleNodePool")
