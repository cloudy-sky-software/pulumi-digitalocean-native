...
def get_kubernetes_node_pool(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str node_pool_id: A unique ID that can be used to reference a Kubernetes node pool.
    """
    __args__ = dict()
...
def get_kubernetes_node_pool_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
