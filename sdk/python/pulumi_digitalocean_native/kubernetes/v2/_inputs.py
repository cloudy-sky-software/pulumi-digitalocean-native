...
class KubernetesNodePoolTaintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key: An arbitrary string. The `key` and `value` fields of the `taint` object form a key-value pair. For example, if the value of the `key` field is "special" and the value of the `value` field is "gpu", the key value pair would be `special=gpu`.
        :param pulumi.Input[_builtins.str] value: An arbitrary string. The `key` and `value` fields of the `taint` object form a key-value pair. For example, if the value of the `key` field is "special" and the value of the `value` field is "gpu", the key value pair would be `special=gpu`.
        """
...
class KubernetesNodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: A unique ID that can be used to identify and reference a specific node pool.
...
class MaintenancePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] duration: The duration of the maintenance window policy in human-readable format.
...
class NodeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the node was created.
        :param pulumi.Input[_builtins.str] droplet_id: The ID of the Droplet used for the worker node.
        :param pulumi.Input[_builtins.str] id: A unique ID that can be used to identify and reference the node.
        :param pulumi.Input[_builtins.str] name: An automatically generated, human-readable name for the node.
        ...
        :param pulumi.Input[_builtins.str] updated_at: A time value given in ISO8601 combined date and time format that represents when the node was last updated.
        """
