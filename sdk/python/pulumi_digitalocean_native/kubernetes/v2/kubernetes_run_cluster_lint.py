...
class KubernetesRunClusterLintArgs:
    def __init__(__self__, *,
                 ...
                 exclude_checks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 exclude_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_checks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a KubernetesRunClusterLint resource.
        :param pulumi.Input[builtins.str] cluster_id: A unique ID that can be used to reference a Kubernetes cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_checks: An array of checks that will be run when clusterlint executes checks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_groups: An array of check groups that will be omitted when clusterlint executes checks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_checks: An array of checks that will be run when clusterlint executes checks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_groups: An array of check groups that will be run when clusterlint executes checks.
        """
    ...
    def exclude_checks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def exclude_checks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_checks", value)

    @property
    @pulumi.getter(name="excludeGroups")
    def exclude_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def exclude_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_groups", value)

    @property
    @pulumi.getter(name="includeChecks")
    def include_checks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of checks that will be run when clusterlint executes checks.
        """
    ...
    def include_checks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "include_checks", value)

    @property
    @pulumi.getter(name="includeGroups")
    def include_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def include_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class KubernetesRunClusterLint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="excludeChecks")
    def exclude_checks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of checks that will be run when clusterlint executes checks.
        """
        return pulumi.get(self, "exclude_checks")
    ...
    @property
    @pulumi.getter(name="excludeGroups")
    def exclude_groups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of check groups that will be omitted when clusterlint executes checks.
        """
        return pulumi.get(self, "exclude_groups")
    ...
    @property
    @pulumi.getter(name="includeChecks")
    def include_checks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of checks that will be run when clusterlint executes checks.
        """
        return pulumi.get(self, "include_checks")
    ...
    @property
    @pulumi.getter(name="includeGroups")
    def include_groups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of check groups that will be run when clusterlint executes checks.
        """
        return pulumi.get(self, "include_groups")
    ...
    def run_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
