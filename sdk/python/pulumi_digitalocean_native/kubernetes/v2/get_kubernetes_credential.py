...
def get_kubernetes_credential(cluster_id: Optional[_builtins.str] = None,
...
def get_kubernetes_credential_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[Credentials]:
    """
    Use this data source to access information about an existing resource.
