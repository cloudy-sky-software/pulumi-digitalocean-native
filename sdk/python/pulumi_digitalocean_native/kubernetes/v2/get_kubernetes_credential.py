...
def get_kubernetes_credential(cluster_id: Optional[builtins.str] = None,
...
def get_kubernetes_credential_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
