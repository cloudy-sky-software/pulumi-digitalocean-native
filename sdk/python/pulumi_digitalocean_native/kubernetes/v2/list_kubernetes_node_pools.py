...
def list_kubernetes_node_pools(cluster_id: Optional[_builtins.str] = None,
...
def list_kubernetes_node_pools_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
