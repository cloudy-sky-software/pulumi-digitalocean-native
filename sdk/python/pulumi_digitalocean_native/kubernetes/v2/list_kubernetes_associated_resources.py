...
def list_kubernetes_associated_resources(cluster_id: Optional[builtins.str] = None,
...
def list_kubernetes_associated_resources_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
