...
class KubernetesClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The slug identifier for the region where the Kubernetes cluster is located.
        :param pulumi.Input[_builtins.str] version: The slug identifier for the version of Kubernetes used for the cluster. If set to a minor version (e.g. "1.14"), the latest version within it will be used (e.g. "1.14.6-do.1"); if set to "latest", the latest published version will be used. See the `/v2/kubernetes/options` endpoint to find all currently available versions.
        ...
        :param pulumi.Input[_builtins.bool] ha: A boolean value indicating whether the control plane is run in a highly available configuration in the cluster. Highly available control planes incur less downtime. The property cannot be disabled.
        ...
        :param pulumi.Input[_builtins.str] name: A human-readable name for a Kubernetes cluster.
        :param pulumi.Input[_builtins.bool] surge_upgrade: A boolean value indicating whether surge upgrade is enabled/disabled for the cluster. Surge upgrade makes cluster upgrades fast and reliable by bringing up new nodes before destroying the outdated nodes.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: An array of tags applied to the Kubernetes cluster. All clusters are automatically tagged `k8s` and `k8s:$K8S_CLUSTER_ID`.
        :param pulumi.Input[_builtins.str] vpc_uuid: A string specifying the UUID of the VPC to which the Kubernetes cluster is assigned.
        """
...
@pulumi.type_token("digitalocean-native:kubernetes/v2:KubernetesCluster")
class KubernetesCluster(pulumi.CustomResource):
    ...
    def cluster_subnet(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
    ...
    def service_subnet(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
