...
class TagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the tag. Tags may contain letters, numbers, colons, dashes, and underscores.
...
@pulumi.type_token("digitalocean-native:tags/v2:Tag")
