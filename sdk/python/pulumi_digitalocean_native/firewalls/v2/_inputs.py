...
class FirewallRulesInboundRulesItemArgs:
    def __init__(__self__, *,
                 ...
                 protocol: pulumi.Input['FirewallRuleBaseProtocol']):
        """
        :param pulumi.Input[_builtins.str] ports: The ports on which traffic will be allowed specified as a string containing a single port, a range (e.g. "8000-9000"), or "0" when all ports are open for a protocol. For ICMP rules this parameter will always return "0".
