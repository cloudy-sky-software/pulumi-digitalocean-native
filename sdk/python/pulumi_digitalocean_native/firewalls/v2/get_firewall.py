...
def get_firewall(firewall_id: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallProperties:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str firewall_id: A unique ID that can be used to identify and reference a firewall.
    """
    __args__ = dict()
...
def get_firewall_output(firewall_id: Optional[pulumi.Input[builtins.str]] = None,
