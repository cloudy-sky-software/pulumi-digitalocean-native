...
class FirewallsAssignDropletArgs:
    def __init__(__self__, *,
                 droplet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] droplet_ids: An array containing the IDs of the Droplets to be assigned to the firewall.
        :param pulumi.Input[_builtins.str] firewall_id: A unique ID that can be used to identify and reference a firewall.
        """
    ...
    def droplet_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]:
        """
    ...
    @droplet_ids.setter
    def droplet_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]):
...
@pulumi.type_token("digitalocean-native:firewalls/v2:FirewallsAssignDroplet")
