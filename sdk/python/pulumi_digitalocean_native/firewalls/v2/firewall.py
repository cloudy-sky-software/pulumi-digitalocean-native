...
class FirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the firewall was created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] droplet_ids: An array containing the IDs of the Droplets assigned to the firewall.
        :param pulumi.Input[_builtins.str] name: A human-readable name for a firewall. The name must begin with an alphanumeric character. Subsequent characters must either be alphanumeric characters, a period (.), or a dash (-).
...
@pulumi.type_token("digitalocean-native:firewalls/v2:Firewall")
