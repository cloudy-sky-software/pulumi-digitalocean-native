...
def get_databases_replica(database_cluster_uuid: Optional[_builtins.str] = None,
    ...
    :param _builtins.str replica_name: The name of the database replica.
    """
    __args__ = dict()
...
def get_databases_replica_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
