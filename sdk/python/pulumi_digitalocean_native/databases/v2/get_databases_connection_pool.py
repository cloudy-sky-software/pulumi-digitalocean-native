...
def get_databases_connection_pool(database_cluster_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str pool_name: The name used to identify the connection pool.
    """
    __args__ = dict()
...
def get_databases_connection_pool_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
