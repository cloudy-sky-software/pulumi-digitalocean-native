...
def get_databases_sql_mode(database_cluster_uuid: Optional[builtins.str] = None,
...
def get_databases_sql_mode_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
