...
class DatabasesUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] readonly: For MongoDB clusters, set to `true` to create a read-only user.
...
@pulumi.type_token("digitalocean-native:databases/v2:DatabasesUser")
class DatabasesUser(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def readonly(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        For MongoDB clusters, set to `true` to create a read-only user.
        This option is not currently supported for other database engines.
        """
