...
def get_database(database_cluster_uuid: Optional[builtins.str] = None,
...
def get_database_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
