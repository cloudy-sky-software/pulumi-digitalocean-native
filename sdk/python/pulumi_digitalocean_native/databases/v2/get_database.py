...
def get_database(database_cluster_uuid: Optional[_builtins.str] = None,
...
def get_database_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
