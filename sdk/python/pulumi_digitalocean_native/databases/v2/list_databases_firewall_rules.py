...
def list_databases_firewall_rules(database_cluster_uuid: Optional[builtins.str] = None,
...
def list_databases_firewall_rules_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
