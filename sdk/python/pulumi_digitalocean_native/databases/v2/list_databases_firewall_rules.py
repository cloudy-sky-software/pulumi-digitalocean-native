...
def list_databases_firewall_rules(database_cluster_uuid: Optional[_builtins.str] = None,
...
def list_databases_firewall_rules_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
