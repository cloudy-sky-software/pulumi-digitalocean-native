...
@pulumi.type_token("digitalocean-native:databases/v2:DatabasesMaintenanceWindow")
class DatabasesMaintenanceWindow(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def description(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def pending(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
