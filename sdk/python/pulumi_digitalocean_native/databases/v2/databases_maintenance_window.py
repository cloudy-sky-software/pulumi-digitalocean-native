...
class DatabasesMaintenanceWindow(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def day(self) -> pulumi.Output[builtins.str]:
        """
        The day of the week on which to apply maintenance updates.
        """
        return pulumi.get(self, "day")
    ...
    @property
    @pulumi.getter
    def description(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
    ...
    @property
    @pulumi.getter
    def hour(self) -> pulumi.Output[builtins.str]:
        """
        The hour in UTC at which maintenance updates will be applied in 24 hour format.
        """
        return pulumi.get(self, "hour")
    ...
    @property
    @pulumi.getter
    def pending(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
