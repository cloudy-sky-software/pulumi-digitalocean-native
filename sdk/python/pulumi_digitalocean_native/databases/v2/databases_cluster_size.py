...
class DatabasesClusterSizeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] num_nodes: The number of nodes in the database cluster. Valid values are are 1-3. In addition to the primary node, up to two standby nodes may be added for highly available configurations.
        :param pulumi.Input[_builtins.str] size: A slug identifier representing desired the size of the nodes in the database cluster.
...
@pulumi.type_token("digitalocean-native:databases/v2:DatabasesClusterSize")
