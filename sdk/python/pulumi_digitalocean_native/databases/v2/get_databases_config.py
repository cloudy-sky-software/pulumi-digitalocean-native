...
def get_databases_config(database_cluster_uuid: Optional[builtins.str] = None,
...
def get_databases_config_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
