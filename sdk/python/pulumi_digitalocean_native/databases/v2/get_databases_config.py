...
def get_databases_config(database_cluster_uuid: Optional[_builtins.str] = None,
...
def get_databases_config_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
