...
def get_databases_ca(database_cluster_uuid: Optional[_builtins.str] = None,
...
def get_databases_ca_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
