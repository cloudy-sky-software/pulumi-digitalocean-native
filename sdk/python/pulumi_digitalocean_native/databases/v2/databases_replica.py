...
class DatabasesReplicaArgs:
    def __init__(__self__, *,
                 ...
                 database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name to give the read-only replicating
        ...
        :param pulumi.Input[_builtins.str] database_cluster_uuid: A unique identifier for a database cluster.
        :param pulumi.Input[_builtins.str] private_network_uuid: A string specifying the UUID of the VPC to which the read-only replica will be assigned. If excluded, the replica will be assigned to your account's default VPC for the region.
        :param pulumi.Input[_builtins.str] region: A slug identifier for the region where the read-only replica will be located. If excluded, the replica will be placed in the same region as the cluster.
        :param pulumi.Input[_builtins.str] size: A slug identifier representing the size of the node for the read-only replica. The size of the replica must be at least as large as the node size for the database cluster from which it is replicating.
        :param pulumi.Input['DatabaseReplicaStatus'] status: A string representing the current status of the database cluster.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A flat array of tag names as strings to apply to the read-only replica after it is created. Tag names can either be existing or new tags.
        """
    ...
    def database_cluster_uuid(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def database_cluster_uuid(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("digitalocean-native:databases/v2:DatabasesReplica")
class DatabasesReplica(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 connection: Optional[pulumi.Input[Union['DatabaseReplicaConnectionArgs', 'DatabaseReplicaConnectionArgsDict']]] = None,
                 created_at: Optional[pulumi.Input[_builtins.str]] = None,
                 database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 private_connection: Optional[pulumi.Input[Union['DatabaseReplicaPrivateConnectionArgs', 'DatabaseReplicaPrivateConnectionArgsDict']]] = None,
                 private_network_uuid: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 size: Optional[pulumi.Input[_builtins.str]] = None,
                 status: Optional[pulumi.Input['DatabaseReplicaStatus']] = None,
