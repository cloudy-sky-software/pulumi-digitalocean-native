...
def list_databases(database_cluster_uuid: Optional[builtins.str] = None,
...
def list_databases_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
