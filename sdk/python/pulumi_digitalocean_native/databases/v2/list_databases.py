...
def list_databases(database_cluster_uuid: Optional[_builtins.str] = None,
...
def list_databases_output(database_cluster_uuid: Optional[pulumi.Input[_builtins.str]] = None,
