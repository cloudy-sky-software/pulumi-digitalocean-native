...
def get_databases_eviction_policy(database_cluster_uuid: Optional[builtins.str] = None,
...
def get_databases_eviction_policy_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
