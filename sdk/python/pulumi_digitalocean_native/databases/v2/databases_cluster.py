...
class DatabasesClusterArgs:
    def __init__(__self__, *,
                 ...
                 num_nodes: pulumi.Input[builtins.int],
                 ...
                 db_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 semantic_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 version_end_of_availability: Optional[pulumi.Input[builtins.str]] = None,
                 version_end_of_life: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: A unique, human-readable name referring to a database cluster.
        :param pulumi.Input[builtins.int] num_nodes: The number of nodes in the database cluster.
        :param pulumi.Input[builtins.str] region: The slug identifier for the region where the database cluster is located.
        :param pulumi.Input[builtins.str] size: The slug identifier representing the size of the nodes in the database cluster.
        :param pulumi.Input[builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the database cluster was created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_names: An array of strings containing the names of databases created in the database cluster.
        :param pulumi.Input[builtins.str] private_network_uuid: A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.
        ...
        :param pulumi.Input[builtins.str] semantic_version: A string representing the semantic version of the database engine in use for the cluster.
        :param pulumi.Input['DatabaseClusterStatus'] status: A string representing the current status of the database cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: An array of tags that have been applied to the database cluster.
        :param pulumi.Input[builtins.str] version: A string representing the version of the database engine in use for the cluster.
        :param pulumi.Input[builtins.str] version_end_of_availability: A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        :param pulumi.Input[builtins.str] version_end_of_life: A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
    ...
    def num_nodes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @num_nodes.setter
    def num_nodes(self, value: pulumi.Input[builtins.int]):
    ...
    def db_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @db_names.setter
    def db_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def semantic_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def semantic_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def version_end_of_availability(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def version_end_of_availability(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "version_end_of_availability", value)

    @property
    @pulumi.getter(name="versionEndOfLife")
    def version_end_of_life(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def version_end_of_life(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabasesCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dbNames")
    def db_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of strings containing the names of databases created in the database cluster.
        """
        return pulumi.get(self, "db_names")
    ...
    @property
    @pulumi.getter(name="numNodes")
    def num_nodes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of nodes in the database cluster.
        """
        return pulumi.get(self, "num_nodes")
    ...
    @property
    @pulumi.getter(name="privateNetworkUuid")
    def private_network_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.
        """
        return pulumi.get(self, "private_network_uuid")
    ...
    @property
    @pulumi.getter(name="semanticVersion")
    def semantic_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A string representing the semantic version of the database engine in use for the cluster.
        """
        return pulumi.get(self, "semantic_version")
    ...
    @property
    @pulumi.getter(name="versionEndOfAvailability")
    def version_end_of_availability(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        """
        return pulumi.get(self, "version_end_of_availability")
    ...
    @property
    @pulumi.getter(name="versionEndOfLife")
    def version_end_of_life(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
        return pulumi.get(self, "version_end_of_life")
