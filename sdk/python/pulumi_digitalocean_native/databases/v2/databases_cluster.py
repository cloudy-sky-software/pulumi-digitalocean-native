...
class DatabasesClusterArgs:
    def __init__(__self__, *,
                 ...
                 semantic_version: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 version_end_of_availability: Optional[pulumi.Input[_builtins.str]] = None,
                 version_end_of_life: Optional[pulumi.Input[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: A unique, human-readable name referring to a database cluster.
        :param pulumi.Input[_builtins.int] num_nodes: The number of nodes in the database cluster.
        :param pulumi.Input[_builtins.str] region: The slug identifier for the region where the database cluster is located.
        :param pulumi.Input[_builtins.str] size: The slug identifier representing the size of the nodes in the database cluster.
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the database cluster was created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] db_names: An array of strings containing the names of databases created in the database cluster.
        :param pulumi.Input[_builtins.str] private_network_uuid: A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.
        ...
        :param pulumi.Input[_builtins.str] semantic_version: A string representing the semantic version of the database engine in use for the cluster.
        :param pulumi.Input['DatabaseClusterStatus'] status: A string representing the current status of the database cluster.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: An array of tags that have been applied to the database cluster.
        :param pulumi.Input[_builtins.str] version: A string representing the version of the database engine in use for the cluster.
        :param pulumi.Input[_builtins.str] version_end_of_availability: A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        :param pulumi.Input[_builtins.str] version_end_of_life: A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
    ...
    def semantic_version(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def semantic_version(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def version_end_of_availability(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def version_end_of_availability(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "version_end_of_availability", value)

    @_builtins.property
    @pulumi.getter(name="versionEndOfLife")
    def version_end_of_life(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def version_end_of_life(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "version_end_of_life", value)


@pulumi.type_token("digitalocean-native:databases/v2:DatabasesCluster")
class DatabasesCluster(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="numNodes")
    def num_nodes(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of nodes in the database cluster.
        """
        return pulumi.get(self, "num_nodes")
    ...
    @_builtins.property
    @pulumi.getter(name="privateNetworkUuid")
    def private_network_uuid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.
        """
        return pulumi.get(self, "private_network_uuid")
    ...
    @_builtins.property
    @pulumi.getter(name="versionEndOfAvailability")
    def version_end_of_availability(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        """
        return pulumi.get(self, "version_end_of_availability")
    ...
    @_builtins.property
    @pulumi.getter(name="versionEndOfLife")
    def version_end_of_life(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
        return pulumi.get(self, "version_end_of_life")
