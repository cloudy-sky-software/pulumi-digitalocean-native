...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] database: The name of the default database.
        :param pulumi.Input[_builtins.str] host: The FQDN pointing to the database cluster's current primary node.
        :param pulumi.Input[_builtins.str] password: The randomly generated password for the default user.
        :param pulumi.Input[_builtins.int] port: The port on which the database cluster is listening.
        :param pulumi.Input[_builtins.bool] ssl: A boolean value indicating if the connection should be made over SSL.
        :param pulumi.Input[_builtins.str] uri: A connection string in the format accepted by the `psql` command. This is provided as a convenience and should be able to be constructed by the other attributes.
        :param pulumi.Input[_builtins.str] user: The default user for the database.
        """
...
if not MYPY:
    class DatabaseClusterMaintenanceWindowArgsDict(TypedDict):
        ...
        """
        description: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
        """
        A list of strings, each containing information about a pending maintenance update.
        """
        pending: NotRequired[pulumi.Input[_builtins.bool]]
        """
...
class DatabaseClusterMaintenanceWindowArgs:
    def __init__(__self__, *,
                 day: pulumi.Input[_builtins.str],
                 hour: pulumi.Input[_builtins.str],
                 description: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 pending: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] day: The day of the week on which to apply maintenance updates.
        :param pulumi.Input[_builtins.str] hour: The hour in UTC at which maintenance updates will be applied in 24 hour format.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] description: A list of strings, each containing information about a pending maintenance update.
        :param pulumi.Input[_builtins.bool] pending: A boolean value indicating whether any maintenance is scheduled to be performed in the next window.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def description(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A list of strings, each containing information about a pending maintenance update.
        """
    ...
    @description.setter
    def description(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class DatabaseUserArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of a database user.
        :param pulumi.Input[_builtins.str] password: A randomly generated password for the database user.
...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_uuid: A unique ID for the database cluster to which the rule is applied.
        :param pulumi.Input[_builtins.str] created_at: A time value given in ISO8601 combined date and time format that represents when the firewall rule was created.
        :param pulumi.Input[_builtins.str] uuid: A unique ID for the firewall rule itself.
        """
...
class SourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] dbname: The name of the default database.
        :param pulumi.Input[_builtins.str] host: The FQDN pointing to the database cluster's current primary node.
        :param pulumi.Input[_builtins.str] password: The randomly generated password for the default user.
        :param pulumi.Input[_builtins.int] port: The port on which the database cluster is listening.
