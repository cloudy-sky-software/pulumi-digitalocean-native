...
class DatabasesOnlineMigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disable_ssl: Enables SSL encryption when connecting to the source database.
        """
...
@pulumi.type_token("digitalocean-native:databases/v2:DatabasesOnlineMigration")
