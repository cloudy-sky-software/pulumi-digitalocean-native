...
class DatabasesConnectionPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db: The database for use with the connection pool.
        ...
        :param pulumi.Input[builtins.int] size: The desired size of the PGBouncer connection pool. The maximum allowed size is determined by the size of the cluster's primary node. 25 backend server connections are allowed for every 1GB of RAM. Three are reserved for maintenance. For example, a primary node with 1 GB of RAM allows for a maximum of 22 backend server connections while one with 4 GB would allow for 97. Note that these are shared across all connection pools in a cluster.
        :param pulumi.Input[builtins.str] database_cluster_uuid: A unique identifier for a database cluster.
        :param pulumi.Input[builtins.str] name: A unique name for the connection pool. Must be between 3 and 60 characters.
        :param pulumi.Input[builtins.str] user: The name of the user for use with the connection pool. When excluded, all sessions connect to the database as the inbound user.
        """
...
class DatabasesConnectionPool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def db(self) -> pulumi.Output[builtins.str]:
        """
        The database for use with the connection pool.
        """
        return pulumi.get(self, "db")
