...
def list_databases_connection_pools(database_cluster_uuid: Optional[builtins.str] = None,
...
def list_databases_connection_pools_output(database_cluster_uuid: Optional[pulumi.Input[builtins.str]] = None,
