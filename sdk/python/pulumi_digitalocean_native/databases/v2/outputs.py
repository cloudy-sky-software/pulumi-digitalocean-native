...
class Backup(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format at which the backup was created.
        :param builtins.float size_gigabytes: The size of the database backup in GBs.
        """
...
class Ca(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate: base64 encoding of the certificate used to secure database connections
        """
...
class Connection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database: The name of the default database.
        :param builtins.str host: The FQDN pointing to the database cluster's current primary node.
        :param builtins.str password: The randomly generated password for the default user.
        :param builtins.int port: The port on which the database cluster is listening.
        :param builtins.bool ssl: A boolean value indicating if the connection should be made over SSL.
        :param builtins.str uri: A connection string in the format accepted by the `psql` command. This is provided as a convenience and should be able to be constructed by the other attributes.
        :param builtins.str user: The default user for the database.
        """
...
class ConnectionPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user: Optional[builtins.str] = None):
        """
        :param builtins.str db: The database for use with the connection pool.
        :param builtins.str mode: The PGBouncer transaction mode for the connection pool. The allowed values are session, transaction, and statement.
        :param builtins.str name: A unique name for the connection pool. Must be between 3 and 60 characters.
        :param builtins.int size: The desired size of the PGBouncer connection pool. The maximum allowed size is determined by the size of the cluster's primary node. 25 backend server connections are allowed for every 1GB of RAM. Three are reserved for maintenance. For example, a primary node with 1 GB of RAM allows for a maximum of 22 backend server connections while one with 4 GB would allow for 97. Note that these are shared across all connection pools in a cluster.
        :param builtins.str user: The name of the user for use with the connection pool. When excluded, all sessions connect to the database as the inbound user.
        """
...
class DatabaseCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 db_names: Optional[Sequence[builtins.str]] = None,
                 ...
                 private_network_uuid: Optional[builtins.str] = None,
                 ...
                 version_end_of_availability: Optional[builtins.str] = None,
                 version_end_of_life: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str name: A unique, human-readable name referring to a database cluster.
        :param builtins.int num_nodes: The number of nodes in the database cluster.
        :param builtins.str region: The slug identifier for the region where the database cluster is located.
        :param builtins.str size: The slug identifier representing the size of the nodes in the database cluster.
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the database cluster was created.
        :param Sequence[builtins.str] db_names: An array of strings containing the names of databases created in the database cluster.
        :param builtins.str id: A unique ID that can be used to identify and reference a database cluster.
        :param builtins.str private_network_uuid: A string specifying the UUID of the VPC to which the database cluster will be assigned. If excluded, the cluster when creating a new database cluster, it will be assigned to your account's default VPC for the region.
        :param builtins.str project_id: The ID of the project that the database cluster is assigned to. If excluded when creating a new database cluster, it will be assigned to your default project.
        :param builtins.str semantic_version: A string representing the semantic version of the database engine in use for the cluster.
        :param 'DatabaseClusterStatus' status: A string representing the current status of the database cluster.
        :param Sequence[builtins.str] tags: An array of tags that have been applied to the database cluster.
        :param builtins.str version: A string representing the version of the database engine in use for the cluster.
        :param builtins.str version_end_of_availability: A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        :param builtins.str version_end_of_life: A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
    ...
    def db_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def private_network_uuid(self) -> Optional[builtins.str]:
        """
    ...
    def semantic_version(self) -> Optional[builtins.str]:
        """
    ...
    def version_end_of_availability(self) -> Optional[builtins.str]:
        """
    ...
    def version_end_of_life(self) -> Optional[builtins.str]:
        """
...
class DatabaseClusterMaintenanceWindow(dict):
    def __init__(__self__, *,
                 day: builtins.str,
                 hour: builtins.str,
                 description: Optional[Sequence[builtins.str]] = None,
                 pending: Optional[builtins.bool] = None):
        """
        ...
        :param Sequence[builtins.str] description: A list of strings, each containing information about a pending maintenance update.
        :param builtins.bool pending: A boolean value indicating whether any maintenance is scheduled to be performed in the next window.
        """
    ...
    @property
    @pulumi.getter
    def description(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def pending(self) -> Optional[builtins.bool]:
        """
...
class DatabaseLayoutOption(dict):
    def __init__(__self__, *,
                 ...
                 sizes: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] sizes: An array of objects containing the slugs available with various node counts
        """
    ...
    @property
    @pulumi.getter
    def sizes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DatabaseReplica(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: The name to give the read-only replicating
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the database cluster was created.
        :param builtins.str id: A unique ID that can be used to identify and reference a database replica.
        :param builtins.str private_network_uuid: A string specifying the UUID of the VPC to which the read-only replica will be assigned. If excluded, the replica will be assigned to your account's default VPC for the region.
        :param builtins.str region: A slug identifier for the region where the read-only replica will be located. If excluded, the replica will be placed in the same region as the cluster.
        :param builtins.str size: A slug identifier representing the size of the node for the read-only replica. The size of the replica must be at least as large as the node size for the database cluster from which it is replicating.
        :param 'DatabaseReplicaStatus' status: A string representing the current status of the database cluster.
        :param Sequence[builtins.str] tags: A flat array of tag names as strings to apply to the read-only replica after it is created. Tag names can either be existing or new tags.
        """
        pulumi.set(__self__, "name", name)
        if connection is not None:
            pulumi.set(__self__, "connection", connection)
...
class DatabaseUser(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of a database user.
        :param builtins.str password: A randomly generated password for the database user.
...
class DatabaseVersionAvailability(dict):
    def __init__(__self__, *,
                 end_of_availability: Optional[builtins.str] = None,
                 end_of_life: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str end_of_availability: A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        :param builtins.str end_of_life: A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        :param builtins.str version: The engine version.
        """
    ...
    def end_of_availability(self) -> Optional[builtins.str]:
        """
        A timestamp referring to the date when the particular version will no longer be available for creating new clusters. If null, the version does not have an end of availability timeline.
        """
    ...
    def end_of_life(self) -> Optional[builtins.str]:
        """
        A timestamp referring to the date when the particular version will no longer be supported. If null, the version does not have an end of life timeline.
        """
...
class FirewallRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str cluster_uuid: A unique ID for the database cluster to which the rule is applied.
        :param builtins.str created_at: A time value given in ISO8601 combined date and time format that represents when the firewall rule was created.
        :param builtins.str uuid: A unique ID for the firewall rule itself.
        """
...
class Mysql(dict):
    def __init__(__self__, *,
                 ...
                 binlog_retention_period: Optional[builtins.float] = None,
        ...
        """
        :param builtins.int backup_hour: The hour of day (in UTC) when backup for the service starts. New backup only starts if previous backup has already completed.
        :param builtins.int backup_minute: The minute of the backup hour when backup for the service starts. New backup  only starts if previous backup has already completed.
        :param builtins.float binlog_retention_period: The minimum amount of time, in seconds, to keep binlog entries before deletion.  This may be extended for services that require binlog entries for longer than the default, for example if using the MySQL Debezium Kafka connector.
        ...
        :param builtins.str default_time_zone: Default server time zone, in the form of an offset from UTC (from -12:00 to +12:00), a time zone name (EST), or 'SYSTEM' to use the MySQL server default.
        ...
        :param builtins.int innodb_ft_min_token_size: The minimum length of words that an InnoDB FULLTEXT index stores.
        :param builtins.str innodb_ft_server_stopword_table: The InnoDB FULLTEXT index stopword list for all InnoDB tables.
        :param builtins.int innodb_lock_wait_timeout: The time, in seconds, that an InnoDB transaction waits for a row lock. before giving up.
        :param builtins.int innodb_log_buffer_size: The size of the buffer, in bytes, that InnoDB uses to write to the log files. on disk.
        :param builtins.int innodb_online_alter_log_max_size: The upper limit, in bytes, of the size of the temporary log files used during online DDL operations for InnoDB tables.
        :param builtins.bool innodb_print_all_deadlocks: When enabled, records information about all deadlocks in InnoDB user transactions  in the error log. Disabled by default.
        :param builtins.bool innodb_rollback_on_timeout: When enabled, transaction timeouts cause InnoDB to abort and roll back the entire transaction.
        :param builtins.int interactive_timeout: The time, in seconds, the server waits for activity on an interactive. connection before closing it.
        ...
        :param builtins.float long_query_time: The time, in seconds, for a query to take to execute before  being captured by slow_query_logs. Default is 10 seconds.
        :param builtins.int max_allowed_packet: The size of the largest message, in bytes, that can be received by the server. Default is 67108864 (64M).
        :param builtins.int max_heap_table_size: The maximum size, in bytes, of internal in-memory tables. Also set tmp_table_size. Default is 16777216 (16M)
        :param builtins.int net_read_timeout: The time, in seconds, to wait for more data from an existing connection. aborting the read.
        ...
        :param builtins.bool slow_query_log: When enabled, captures slow queries. When disabled, also truncates the mysql.slow_log table. Default is false.
        :param builtins.int sort_buffer_size: The sort buffer size, in bytes, for ORDER BY optimization. Default is 262144. (256K).
        :param builtins.str sql_mode: Global SQL mode. If empty, uses MySQL server defaults. Must only include uppercase alphabetic characters, underscores, and commas.
        ...
        :param builtins.int tmp_table_size: The maximum size, in bytes, of internal in-memory tables. Also set max_heap_table_size. Default is 16777216 (16M).
    ...
    def binlog_retention_period(self) -> Optional[builtins.float]:
        """
...
class OptionsOptionsPropertiesMongodb(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] regions: An array of strings containing the names of available regions
        :param Sequence[builtins.str] versions: An array of strings containing the names of available regions
        """
...
class Pgbouncer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PGBouncer connection pooling settings
        :param builtins.int autodb_idle_timeout: If the automatically-created database pools have been unused this many seconds, they are freed. If 0, timeout is disabled.
        :param builtins.int autodb_max_db_connections: Only allows a maximum this many server connections per database (regardless of user). If 0, allows unlimited connections.
        :param 'PgbouncerAutodbPoolMode' autodb_pool_mode: PGBouncer pool mode
        :param builtins.int autodb_pool_size: If non-zero, automatically creates a pool of that size per user when a pool doesn't exist.
        ...
        :param builtins.int min_pool_size: If current server connections are below this number, adds more. Improves behavior when usual load comes suddenly back after period of total inactivity. The value is effectively capped at the pool size.
        :param builtins.int server_idle_timeout: Drops server connections if they have been idle more than this many seconds.  If 0, timeout is disabled. 
        :param builtins.int server_lifetime: The pooler closes any unused server connection that has been connected longer than this amount of seconds.
...
class Postgres(dict):
    def __init__(__self__, *,
                 ...
                 stat_monitor_enable: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.float autovacuum_analyze_scale_factor: Specifies a fraction, in a decimal value, of the table size to add to autovacuum_analyze_threshold when deciding whether to trigger an ANALYZE. The default is 0.2 (20% of table size).
        ...
        :param builtins.int autovacuum_naptime: Specifies the minimum delay, in seconds, between autovacuum runs on any given database. The default is one minute.
        :param builtins.int autovacuum_vacuum_cost_delay: Specifies the cost delay value, in milliseconds, that will be used in automatic VACUUM operations. If -1, uses the regular vacuum_cost_delay value, which is 20 milliseconds.
        ...
        :param builtins.float autovacuum_vacuum_scale_factor: Specifies a fraction, in a decimal value, of the table size to add to autovacuum_vacuum_threshold when deciding whether to trigger a VACUUM. The default is 0.2 (20% of table size).
        ...
        :param builtins.int backup_hour: The hour of day (in UTC) when backup for the service starts. New backup only starts if previous backup has already completed.
        :param builtins.int backup_minute: The minute of the backup hour when backup for the service starts. New backup is only started if previous backup has already completed.
        :param builtins.int bgwriter_delay: Specifies the delay, in milliseconds, between activity rounds for the background writer. Default is 200 ms.
        :param builtins.int bgwriter_flush_after: The amount of kilobytes that need to be written by the background writer before attempting to force the OS to issue these writes to underlying storage. Specified in kilobytes, default is 512.  Setting of 0 disables forced writeback.
        :param builtins.int bgwriter_lru_maxpages: The maximum number of buffers that the background writer can write. Setting this to zero disables background writing. Default is 100.
        ...
        :param builtins.int deadlock_timeout: The amount of time, in milliseconds, to wait on a lock before checking to see if there is a deadlock condition.
        ...
        :param builtins.bool jit: Activates, in a boolean, the system-wide use of Just-in-Time Compilation (JIT).
        ...
        :param builtins.int log_min_duration_statement: Log statements that take more than this number of milliseconds to run. If -1, disables.
        :param builtins.int max_files_per_process: PostgreSQL maximum number of files that can be open per process.
        :param builtins.int max_locks_per_transaction: PostgreSQL maximum locks per transaction. Once increased, this parameter cannot be lowered from its set value.
        ...
        :param builtins.int max_prepared_transactions: PostgreSQL maximum prepared transactions. Once increased, this parameter cannot be lowered from its set value.
        ...
        :param builtins.int max_wal_senders: PostgreSQL maximum WAL senders. Once increased, this parameter cannot be lowered from its set value.
        :param builtins.int max_worker_processes: Sets the maximum number of background processes that the system can support. Once increased, this parameter cannot be lowered from its set value.
        :param builtins.int pg_partman_bgw_interval: Sets the time interval to run pg_partman's scheduled tasks.
        :param builtins.str pg_partman_bgw_role: Controls which role to use for pg_partman's scheduled background tasks. Must consist of alpha-numeric characters, dots, underscores, or dashes. May not start with dash or dot. Maximum of 64 characters.
        ...
        :param builtins.bool stat_monitor_enable: Enable the pg_stat_monitor extension. <b>Enabling this extension will cause the cluster to be restarted.</b> When this extension is enabled, pg_stat_statements results for utility commands are unreliable.
        ...
        :param builtins.int temp_file_limit: PostgreSQL temporary file limit in KiB. If -1, sets to unlimited.
        ...
        :param builtins.int wal_sender_timeout: Terminate replication connections that are inactive for longer than this amount of time, in milliseconds. Setting this value to zero disables the timeout. Must be either 0 or between 5000 and 10800000.
        ...
        :param builtins.int work_mem: The maximum amount of memory, in MB, used by a query operation (such as a sort or hash table) before writing to temporary disk files. Default is 1MB + 0.075% of total RAM (up to 32MB).
        """
    ...
    def stat_monitor_enable(self) -> Optional[builtins.bool]:
        """
...
class Redis(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int redis_io_threads: Redis IO thread count
        ...
        :param builtins.int redis_number_of_databases: Set number of redis databases. Changing this will cause a restart of redis service.
        ...
        :param builtins.int redis_pubsub_client_output_buffer_limit: Set output buffer limit for pub / sub clients in MB. The value is the hard limit, the soft limit is 1/4 of the hard limit. When setting the limit, be mindful of the available memory in the selected service plan.
...
class SourceProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dbname: The name of the default database.
        :param builtins.str host: The FQDN pointing to the database cluster's current primary node.
        :param builtins.str password: The randomly generated password for the default user.
        :param builtins.int port: The port on which the database cluster is listening.
        :param builtins.str username: The default user for the database.
        """
...
class Timescaledb(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        TimescaleDB extension configuration values
        :param builtins.int max_background_workers: The number of background workers for timescaledb operations.  Set to the sum of your number of databases and the total number of concurrent background workers you want running at any given point in time.
        """
