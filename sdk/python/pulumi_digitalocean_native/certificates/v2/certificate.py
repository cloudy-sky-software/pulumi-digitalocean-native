...
class CertificateArgs:
    def __init__(__self__, *,
                 dns_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 leaf_certificate: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_names: An array of fully qualified domain names (FQDNs) for which the certificate was issued. A certificate covering all subdomains can be issued using a wildcard (e.g. `*.example.com`).
        :param pulumi.Input[builtins.str] leaf_certificate: The contents of a PEM-formatted public SSL certificate.
        :param pulumi.Input[builtins.str] name: A unique human-readable name referring to a certificate.
        :param pulumi.Input[builtins.str] private_key: The contents of a PEM-formatted private-key corresponding to the SSL certificate.
        :param pulumi.Input[builtins.str] certificate_chain: The full PEM-formatted trust chain between the certificate authority's certificate and your domain's SSL certificate.
    ...
    def dns_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @dns_names.setter
    def dns_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "dns_names", value)

    @property
    @pulumi.getter(name="leafCertificate")
    def leaf_certificate(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def leaf_certificate(self, value: pulumi.Input[builtins.str]):
