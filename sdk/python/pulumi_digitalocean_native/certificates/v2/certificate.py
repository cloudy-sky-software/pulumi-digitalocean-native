...
class CertificateArgs:
    def __init__(__self__, *,
                 ...
                 leaf_certificate: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_names: An array of fully qualified domain names (FQDNs) for which the certificate was issued. A certificate covering all subdomains can be issued using a wildcard (e.g. `*.example.com`).
        :param pulumi.Input[_builtins.str] leaf_certificate: The contents of a PEM-formatted public SSL certificate.
        :param pulumi.Input[_builtins.str] name: A unique human-readable name referring to a certificate.
        :param pulumi.Input[_builtins.str] private_key: The contents of a PEM-formatted private-key corresponding to the SSL certificate.
        :param pulumi.Input[_builtins.str] certificate_chain: The full PEM-formatted trust chain between the certificate authority's certificate and your domain's SSL certificate.
    ...
    def leaf_certificate(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def leaf_certificate(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("digitalocean-native:certificates/v2:Certificate")
