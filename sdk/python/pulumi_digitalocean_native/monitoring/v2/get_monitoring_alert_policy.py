...
def get_monitoring_alert_policy(alert_uuid: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringAlertPolicyProperties:
    """
    Use this data source to access information about an existing resource.

    :param _builtins.str alert_uuid: A unique identifier for an alert policy.
    """
    __args__ = dict()
...
def get_monitoring_alert_policy_output(alert_uuid: Optional[pulumi.Input[_builtins.str]] = None,
