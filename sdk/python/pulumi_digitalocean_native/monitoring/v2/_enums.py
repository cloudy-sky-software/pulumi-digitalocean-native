...
class AlertPolicyCompare(builtins.str, Enum):
    GREATER_THAN = "GreaterThan"
    LESS_THAN = "LessThan"


class AlertPolicyType(builtins.str, Enum):
...
class AlertPolicyWindow(builtins.str, Enum):
...
class Compare(builtins.str, Enum):
    GREATER_THAN = "GreaterThan"
    LESS_THAN = "LessThan"


class MetricsDataResultType(builtins.str, Enum):
    MATRIX = "matrix"
...
class Window(builtins.str, Enum):
    WINDOW_5M = "5m"
    WINDOW_10M = "10m"
    WINDOW_30M = "30m"
    WINDOW_1H = "1h"
