...
class AssignArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input['AssignReservedIpActionTypeType'],
        ...
        :param pulumi.Input['AssignReservedIpActionTypeType'] type: The type of action to initiate for the reserved IP.
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input['AssignReservedIpActionTypeType']:
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input['AssignReservedIpActionTypeType']):
...
class Assign(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 reserved_ip: Optional[pulumi.Input[str]] = None,
                 type: Optional[pulumi.Input['AssignReservedIpActionTypeType']] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        super(Assign, __self__).__init__(
            'digitalocean-native:reserved_ips/v2:Assign',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Output[Optional['AssignReservedIpActionTypeType']]:
        """
        The type of action to initiate for the reserved IP.
        """
        return pulumi.get(self, "type")
