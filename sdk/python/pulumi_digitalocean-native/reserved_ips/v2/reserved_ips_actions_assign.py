...
__all__ = ['ReservedIPsActionsAssignArgs', 'ReservedIPsActionsAssign']

@pulumi.input_type
class ReservedIPsActionsAssignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] droplet_id: The ID of the Droplet that the reserved IP will be assigned to.
...
class ReservedIPsActionsAssign(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ReservedIPsActionsAssign resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ReservedIPsActionsAssignArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ReservedIPsActionsAssign resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ReservedIPsActionsAssignArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReservedIPsActionsAssignArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ReservedIPsActionsAssignArgs.__new__(ReservedIPsActionsAssignArgs)
        ...
        super(ReservedIPsActionsAssign, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ReservedIPsActionsAssign':
        """
        ...
        return ReservedIPsActionsAssign(resource_name, opts=opts, __props__=__props__)
