...
class FloatingIPArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] project_id: The UUID of the project to which the floating IP will be assigned.
        :param pulumi.Input[str] region: The slug identifier for the region the floating IP will be reserved to.
        """
