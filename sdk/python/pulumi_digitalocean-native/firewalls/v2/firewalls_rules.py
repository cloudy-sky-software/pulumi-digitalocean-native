...
__all__ = ['FirewallsRulesArgs', 'FirewallsRules']

@pulumi.input_type
class FirewallsRulesArgs:
...
class FirewallsRules(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FirewallsRules resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FirewallsRulesArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a FirewallsRules resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FirewallsRulesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FirewallsRulesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FirewallsRulesArgs.__new__(FirewallsRulesArgs)
        ...
        super(FirewallsRules, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FirewallsRules':
        """
        ...
        return FirewallsRules(resource_name, opts=opts, __props__=__props__)
