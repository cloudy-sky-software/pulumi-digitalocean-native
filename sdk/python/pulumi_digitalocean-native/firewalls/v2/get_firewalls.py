...
class GetFirewallsResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> 'outputs.GetFirewallsProperties':
...
def get_firewalls(firewall_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean-native:firewalls/v2:getFirewalls', __args__, opts=opts, typ=GetFirewallsResult).value
...
def get_firewalls_output(firewall_id: Optional[pulumi.Input[str]] = None,
