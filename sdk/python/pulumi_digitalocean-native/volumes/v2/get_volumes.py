...
class GetVolumesResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> 'outputs.GetVolumesProperties':
...
def get_volumes(volume_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean-native:volumes/v2:getVolumes', __args__, opts=opts, typ=GetVolumesResult).value
...
def get_volumes_output(volume_id: Optional[pulumi.Input[str]] = None,
