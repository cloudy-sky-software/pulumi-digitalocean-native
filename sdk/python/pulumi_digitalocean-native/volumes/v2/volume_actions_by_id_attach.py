...
__all__ = ['VolumeActionsByIdAttachArgs', 'VolumeActionsByIdAttach']

@pulumi.input_type
class VolumeActionsByIdAttachArgs:
...
class VolumeActionsByIdAttach(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a VolumeActionsByIdAttach resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: VolumeActionsByIdAttachArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a VolumeActionsByIdAttach resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param VolumeActionsByIdAttachArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VolumeActionsByIdAttachArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VolumeActionsByIdAttachArgs.__new__(VolumeActionsByIdAttachArgs)
        ...
        super(VolumeActionsByIdAttach, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VolumeActionsByIdAttach':
        """
        ...
        return VolumeActionsByIdAttach(resource_name, opts=opts, __props__=__props__)
