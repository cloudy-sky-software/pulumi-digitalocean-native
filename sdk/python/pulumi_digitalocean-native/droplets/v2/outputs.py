...
class AssociatedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An objects containing information about a resource associated with a Droplet.
        :param str cost: The cost of the resource in USD per month if the resource is retained after the Droplet is destroyed.
        :param str id: The unique identifier for the resource associated with the Droplet.
        :param str name: The name of the resource associated with the Droplet.
        """
        if cost is not None:
...
class DestroyedAssociatedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object containing information about a resource scheduled for deletion.
        :param str destroyed_at: A time value given in ISO8601 combined date and time format indicating when the resource was destroyed if the request was successful.
        :param str error_message: A string indicating that the resource was not successfully destroyed and providing additional information.
        :param str id: The unique identifier for the resource scheduled for deletion.
        :param str name: The name of the resource scheduled for deletion.
        """
    ...
    def destroyed_at(self) -> Optional[str]:
        """
...
@pulumi.output_type
class GetDropletActionsProperties(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class GetDropletsProperties(dict):
    def __init__(__self__, *,
