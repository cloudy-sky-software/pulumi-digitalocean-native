...
__all__ = ['DropletActionsEnableIpv6Args', 'DropletActionsEnableIpv6']

@pulumi.input_type
class DropletActionsEnableIpv6Args:
...
class DropletActionsEnableIpv6(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DropletActionsEnableIpv6Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Specifies the action that will be taken on the Droplet.

        :param str resource_name: The name of the resource.
        :param DropletActionsEnableIpv6Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DropletActionsEnableIpv6Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DropletActionsEnableIpv6Args.__new__(DropletActionsEnableIpv6Args)
        ...
        super(DropletActionsEnableIpv6, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DropletActionsEnableIpv6':
        """
        ...
        return DropletActionsEnableIpv6(resource_name, opts=opts, __props__=__props__)
