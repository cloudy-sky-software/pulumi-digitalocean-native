...
class PowerOffArgs:
    def __init__(__self__, *,
                 type: pulumi.Input['PowerOffType'],
                 droplet_id: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a PowerOff resource.
        :param pulumi.Input['PowerOffType'] type: The type of action to initiate for the Droplet.
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input['PowerOffType']:
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input['PowerOffType']):
...
class PowerOff(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 droplet_id: Optional[pulumi.Input[str]] = None,
                 type: Optional[pulumi.Input['PowerOffType']] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Output['PowerOffType']:
        """
        The type of action to initiate for the Droplet.
        """
        return pulumi.get(self, "type")
