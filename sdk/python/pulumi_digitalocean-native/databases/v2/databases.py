...
__all__ = ['DatabasesArgs', 'Databases']
...
class Databases(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Databases resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DatabasesArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Databases resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DatabasesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabasesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Databases':
        """
        ...
        return Databases(resource_name, opts=opts, __props__=__props__)
