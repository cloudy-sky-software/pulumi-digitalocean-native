...
__all__ = ['LoadBalancersDropletsArgs', 'LoadBalancersDroplets']

@pulumi.input_type
class LoadBalancersDropletsArgs:
...
class LoadBalancersDroplets(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a LoadBalancersDroplets resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LoadBalancersDropletsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a LoadBalancersDroplets resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LoadBalancersDropletsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoadBalancersDropletsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LoadBalancersDropletsArgs.__new__(LoadBalancersDropletsArgs)
        ...
        super(LoadBalancersDroplets, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LoadBalancersDroplets':
        """
        ...
        return LoadBalancersDroplets(resource_name, opts=opts, __props__=__props__)
