...
__all__ = ['LoadBalancersForwardingRulesArgs', 'LoadBalancersForwardingRules']

@pulumi.input_type
class LoadBalancersForwardingRulesArgs:
...
class LoadBalancersForwardingRules(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a LoadBalancersForwardingRules resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LoadBalancersForwardingRulesArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a LoadBalancersForwardingRules resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LoadBalancersForwardingRulesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoadBalancersForwardingRulesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LoadBalancersForwardingRulesArgs.__new__(LoadBalancersForwardingRulesArgs)
        ...
        super(LoadBalancersForwardingRules, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LoadBalancersForwardingRules':
        """
        ...
        return LoadBalancersForwardingRules(resource_name, opts=opts, __props__=__props__)
